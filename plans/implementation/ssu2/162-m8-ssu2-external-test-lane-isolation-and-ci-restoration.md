...
Record the run ID and exact head SHA in `plans/closure/ssu2/162-status.md` before marking Plan 162 passed.

## 7. Plan 161 evidence/status correction

Update `plans/closure/ssu2/161-status.md` as part of this pass, preserving all valid direction-A evidence.
...
After Plan 162 closes, `plans/closure/ssu2/161-status.md` should state that the CI-lane blocker is cleared and the remaining Plan 161 work is still:
...
```text
plans/closure/ssu2/162-status.md
plans/closure/ssu2/161-status.md
plans/closure/ssu2/154-status.md
plans/README.md
README.md
AGENTS.md
...
13. Record exact commands, results, external pin, closing SHA, and CI run ID in `plans/closure/ssu2/162-status.md`.
...
16. `plans/closure/ssu2/161-status.md` retains valid direction-A evidence and records the corrected explicit invocation.
17. `plans/closure/ssu2/162-status.md` records exact closing SHA, commands/results, i2pd pin, and hosted CI run ID.
