...
- `plans/closure/workspace-foundation/002-milestone-0-corrective-closure.md` is complete.
- CI is green.
...
1. `plans/implementation/workspace-foundation/011-m1-codec-foundation.md`
2. `plans/implementation/workspace-foundation/012-m1-common-structures.md`
3. `plans/implementation/workspace-foundation/013-m1-identity-crypto-storage.md`
4. `plans/closure/workspace-foundation/014-m1-i2np-evidence-fuzzing-closure.md`
