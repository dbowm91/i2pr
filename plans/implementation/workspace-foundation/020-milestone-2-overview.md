...
- `plans/closure/workspace-foundation/015-m1-corrective-closure.md`
- `plans/closure/workspace-foundation/010-milestone-1-closure.md` once created
...
1. `plans/implementation/workspace-foundation/021-m2-supervision-cancellation.md`
2. `plans/implementation/workspace-foundation/022-m2-bounded-channels-resource-governor.md`
3. `plans/implementation/workspace-foundation/023-m2-deterministic-network-testkit.md`
4. `plans/closure/workspace-foundation/024-m2-observability-validation-closure.md`
