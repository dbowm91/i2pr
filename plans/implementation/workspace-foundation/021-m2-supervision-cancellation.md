...
- `plans/implementation/workspace-foundation/020-milestone-2-overview.md`
...
- `plans/closure/workspace-foundation/021-closure.md` records APIs, tests, limits, and deviations.
