...
- stop;
- create `plans/closure/sam/146-status.md` with a typed blocker;
...
14. `plans/closure/sam/146-status.md` records exact evidence and sets `next_executable_plan = 147`.
