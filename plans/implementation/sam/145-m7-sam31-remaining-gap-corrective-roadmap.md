...
Supersedes for next-action authority: the `Plan 145 candidate` described in `plans/closure/sam/141-status.md` and `plans/closure/sam/144-status.md`.
...
Execute `plans/implementation/sam/146-m7-sam31-private-destination-reference-requalification.md`.
...
Execute `plans/implementation/sam/147-m7-sam31-dedicated-raw-stream-driver-corrective.md` only after Plan 146 passes.
...
Execute `plans/closure/sam/148-m7-sam31-independent-client-final-closure.md` only after Plan 147 passes.
...
```text
plans/closure/sam/145-status.md
plans/README.md
README.md
AGENTS.md
specs/support.toml
