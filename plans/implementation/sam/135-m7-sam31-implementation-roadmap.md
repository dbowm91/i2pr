...
The original Milestone 7 section in `plans/implementation/workspace-foundation/000-mvp-roadmap.md` omitted `DEST GENERATE`. Plan 135 is the authoritative amendment until Plan 140 folds the correction back into the top-level roadmap.
...
- `plans/implementation/workspace-foundation/000-mvp-roadmap.md` — add `DEST GENERATE`, state SAM 3.1 STREAM baseline, and retain external router interoperability as separate debt.
