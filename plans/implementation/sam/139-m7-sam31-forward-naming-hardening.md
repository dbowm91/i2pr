...
Status: **implemented; closure recorded in [`plans/closure/sam/139-status.md`](../../closure/sam/139-status.md)**.
...
17. `plans/closure/sam/139-status.md` records the resource table, unsupported matrix, and sets `next_executable_plan = 140`.
