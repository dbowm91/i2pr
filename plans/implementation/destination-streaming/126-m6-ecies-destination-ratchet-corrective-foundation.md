...
- Successor: `plans/closure/destination-streaming/127-m6-destination-session-routing-final-closure.md`.
...
Write `plans/closure/destination-streaming/126-status.md` with:
