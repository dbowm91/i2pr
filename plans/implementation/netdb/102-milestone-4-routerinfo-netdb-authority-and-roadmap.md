...
- Parent roadmap: `plans/implementation/workspace-foundation/000-mvp-roadmap.md`, Milestone 4.
...
- Amendment closure: [`plans/closure/netdb/102-amendment-status.md`](../../closure/netdb/102-amendment-status.md).
...
`plans/closure/netdb/102-amendment-status.md`.
...
- `plans/closure/ntcp2-transport/030-milestone-3-closure.md` is an archival Milestone 3 record; its historical "active" blocks do not override Plan 102.
- `plans/closure/ntcp2-transport/099-status.md` remains the authoritative record of the retained NTCP2 development result.
