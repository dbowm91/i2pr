...
- `plans/implementation/mixed-router-interop/183-m6-mixed-router-streaming-interop-program.md`
...
11. `plans/closure/mixed-router-interop/184-status.md` records exact head/run/evidence and advances `next_executable_plan = 185`.
