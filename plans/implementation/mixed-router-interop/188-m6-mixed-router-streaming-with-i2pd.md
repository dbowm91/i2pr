...
12. `plans/closure/mixed-router-interop/188-status.md` records `milestone6_i2pd_streaming_interop = passed` but keeps `milestone6_interoperable = not-yet-claimed`, then advances `next_executable_plan = 189`.
