...
(see `plans/closure/mixed-router-interop/187-status.md` §11): exact-pinned i2pd 2.61.0 accepts
...
- `plans/closure/mixed-router-interop/187-status.md` §11 (six lane runs + manual reproductions).
...
5. `plans/closure/mixed-router-interop/188-status.md` records the root cause, the narrow
