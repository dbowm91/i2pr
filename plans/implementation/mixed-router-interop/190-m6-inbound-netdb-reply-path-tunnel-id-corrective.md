...
[`plans/closure/mixed-router-interop/190-status.md`](../../closure/mixed-router-interop/190-status.md) and
...
10. `plans/closure/mixed-router-interop/190-status.md` is updated with the exact implementation SHA, exact hosted CI run, exact external lane result, and the next demonstrated boundary.
