...
- `plans/implementation/service-tunnels/173-m10-service-tunnels-http-socks5-irc-roadmap.md`
- `plans/closure/i2cp/172-status.md`
- `GUARDRAILS.md`
...
- `plans/closure/service-tunnels/174-status.md`.
...
13. `plans/closure/service-tunnels/174-status.md` records exact evidence and advances `next_executable_plan = 175`.
