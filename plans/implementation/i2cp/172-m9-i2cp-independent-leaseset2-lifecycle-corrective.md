...
- final `plans/closure/i2cp/172-status.md` containing exact SHA, run ids, external pins, evidence artifact id/digest, and commands.
...
24. `plans/closure/i2cp/172-status.md` records command-derived proof and exact hosted evidence.
