...
- Plan-of-record: [`plans/implementation/exploratory-tunnels/114-short-build-terminal-routing-chain-correction.md`](114-short-build-terminal-routing-chain-correction.md)
- Closure: [`plans/closure/exploratory-tunnels/114-status.md`](../../closure/exploratory-tunnels/114-status.md)
- Active successor: [`plans/implementation/exploratory-tunnels/115-qualified-independent-short-build-consumption-and-external-delivery.md`](115-qualified-independent-short-build-consumption-and-external-delivery.md)
- Active handoff: [`plans/implementation/exploratory-tunnels/115-handoff.md`](115-handoff.md)
...
1. [`plans/implementation/exploratory-tunnels/115-handoff.md`](115-handoff.md)
2. [`plans/implementation/exploratory-tunnels/115-qualified-independent-short-build-consumption-and-external-delivery.md`](115-qualified-independent-short-build-consumption-and-external-delivery.md)
3. [`plans/implementation/exploratory-tunnels/115-117-external-delivery-to-live-netdb-roadmap.md`](115-117-external-delivery-to-live-netdb-roadmap.md)
