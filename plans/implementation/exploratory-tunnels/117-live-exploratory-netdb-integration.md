...
- Predecessor: [`116-status.md`](../../closure/exploratory-tunnels/116-status.md) — `passed-final-local-closure`.
...
plans/closure/exploratory-tunnels/117-status.md                        # create only at completion
