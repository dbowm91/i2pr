...
After Work package B, write the selected policy into code comments and `plans/closure/exploratory-tunnels/113-status.md`.
...
On closure, create `plans/closure/exploratory-tunnels/113-status.md` with one exact state.
...
- `plans/implementation/netdb/102-amendment-exploratory-tunnel-dependency.md`;
