...
```text
plans/closure/exploratory-tunnels/116-status.md                 new closure record
plans/implementation/exploratory-tunnels/116-handoff.md                point to Plan 117 only after closure
plans/implementation/exploratory-tunnels/115-handoff.md                remain closed / Plan 116 predecessor
