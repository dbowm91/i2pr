...
- Date: 2026-08-15
- Parent authority: `plans/implementation/netdb/102-amendment-exploratory-tunnel-dependency.md`
- Corrects: Plan 109 and Plan 110 conformance claims
- Predecessors: `plans/closure/exploratory-tunnels/109-status.md`, `plans/closure/exploratory-tunnels/110-status.md`
...
3. record the observed source file/function/commit in `plans/closure/exploratory-tunnels/111-status.md` or closure notes;
...
- `plans/closure/exploratory-tunnels/109-status.md` amendment/banner;
- `plans/closure/exploratory-tunnels/110-status.md` amendment/banner;
- new `plans/closure/exploratory-tunnels/111-status.md` closure record;
- `specs/support.toml`;
...
Create `plans/closure/exploratory-tunnels/111-status.md` only as the implementation progresses; do not pre-mark it passed.
