...
- Date: 2026-08-15
- Plan-of-record: `plans/implementation/exploratory-tunnels/111-short-build-final-local-conformance-correction.md`
- Closure record: `plans/closure/exploratory-tunnels/111-status.md`
- Closed amendment: `plans/closure/exploratory-tunnels/111-post-closure-audit-amendment.md`
- Closed successor roadmap: `plans/implementation/exploratory-tunnels/112-113-post-plan111-pre-delivery-corrective-roadmap.md`
...
See `plans/implementation/netdb/102-amendment-exploratory-tunnel-dependency.md` for current authority precedence.
