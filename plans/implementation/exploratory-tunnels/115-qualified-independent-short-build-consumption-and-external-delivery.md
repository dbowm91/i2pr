...
- Date: 2026-08-17.
- Immediate predecessor: [`plans/closure/exploratory-tunnels/114-status.md`](../../closure/exploratory-tunnels/114-status.md).
- Handoff: [`plans/implementation/exploratory-tunnels/115-handoff.md`](115-handoff.md).
- Roadmap continuation: [`plans/implementation/exploratory-tunnels/115-117-external-delivery-to-live-netdb-roadmap.md`](115-117-external-delivery-to-live-netdb-roadmap.md).
...
Before editing code, write a short execution note in the eventual `plans/closure/exploratory-tunnels/115-status.md` recording the inspected baseline and candidate lane decision.
...
`plans/closure/exploratory-tunnels/115-status.md` must be created by the executor. It is the durable sanitized evidence summary.
...
Reference-specific build/tests should be the minimum native commands needed for the selected pinned revision. Record those commands in `plans/closure/exploratory-tunnels/115-status.md`.
...
1. create `plans/closure/exploratory-tunnels/115-status.md` with the sanitized evidence schema above;
2. update `plans/implementation/exploratory-tunnels/115-handoff.md` from `ready-for-execution` to a closure pointer and name the actual next plan;
