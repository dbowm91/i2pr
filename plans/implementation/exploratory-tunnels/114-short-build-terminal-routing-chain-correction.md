...
- Date: 2026-08-17
- Parent authority: `plans/implementation/netdb/102-milestone-4-routerinfo-netdb-authority-and-roadmap.md`
- Immediate predecessors: `plans/closure/exploratory-tunnels/112-status.md`, `plans/closure/exploratory-tunnels/113-status.md`
...
On successful implementation, add `plans/closure/exploratory-tunnels/114-status.md` and update only the status surfaces needed to make the next step unambiguous.
