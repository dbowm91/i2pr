...
- Supersedes the active gate references in:
  - `plans/implementation/ntcp2-transport/072-activation-amendment-plan-084.md`;
...
Plan 079 may begin only when `plans/closure/ntcp2-transport/088-status.md` records exactly:
...
Plan 072 may activate only when `plans/closure/ntcp2-transport/088-status.md` records exactly:
