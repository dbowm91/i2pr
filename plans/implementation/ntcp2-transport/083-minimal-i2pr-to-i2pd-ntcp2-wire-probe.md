...
- `plans/closure/ntcp2-transport/083-status.md` records exact commands and record digests.
...
The live probe command must be written exactly into `plans/closure/ntcp2-transport/083-status.md` when executed.
...
8. Write `plans/closure/ntcp2-transport/083-status.md` before starting Plan 084.