...
`plans/closure/ntcp2-transport/088-status.md` records the first authoritative attempt, but its wording describes the pre-protocol rejection as a protocol-level classification. `plans/closure/ntcp2-transport/087-status.md` still carries the older `awaiting-one-authoritative-run` token.
...
Update `plans/closure/ntcp2-transport/087-status.md` and `plans/closure/ntcp2-transport/088-status.md` consistently.
...
22. `plans/closure/ntcp2-transport/087-status.md` and `plans/closure/ntcp2-transport/088-status.md` agree on current authority.
