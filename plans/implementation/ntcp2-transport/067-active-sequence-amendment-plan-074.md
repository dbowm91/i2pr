...
- Corrective sub-roadmap: `plans/implementation/ntcp2-transport/074-milestone-3-real-driver-and-constrained-host-corrective-roadmap.md`.
...
plans/closure/ntcp2-transport/030-milestone-3-closure.md or its active amendment
plans/closure/ntcp2-transport/069-status.md through a supersession note, not historical rewrite
```
...
```text
plans/implementation/ntcp2-transport/074-milestone-3-real-driver-and-constrained-host-corrective-roadmap.md
plans/implementation/ntcp2-transport/075-plan-069-runner-integrity-and-evidence-correction.md
```
