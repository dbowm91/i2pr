...
`plans/implementation/workspace-foundation/000-mvp-roadmap.md` defines the Milestone 3 exit criteria:
...
- `plans/implementation/ntcp2-transport/038-ubuntu-reference-router-interoperability-harness.md`
- `plans/closure/ntcp2-transport/038-closure.md`
