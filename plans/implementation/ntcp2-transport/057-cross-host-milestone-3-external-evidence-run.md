...
5. Run every validation command listed in
   `plans/closure/ntcp2-transport/056-candidate.md`. Any failure blocks the run.
...
3. Reconcile `specs/support.toml`,
   `docs/protocol-support.md`, `plans/closure/ntcp2-transport/030-milestone-3-closure.md`,
   `plans/closure/ntcp2-transport/056-closure.md`, and the plan-051 status file to reflect
...
- Updated `plans/closure/ntcp2-transport/030-milestone-3-closure.md`,
  `specs/support.toml`, `docs/protocol-support.md`,
  `plans/closure/ntcp2-transport/056-closure.md`, `plans/051-status`.
