...
plans/closure/ntcp2-transport/064-status.md
```
...
- `plans/closure/ntcp2-transport/064-status.md` records exact commits and makes no mixed-router i2pr success claim.
