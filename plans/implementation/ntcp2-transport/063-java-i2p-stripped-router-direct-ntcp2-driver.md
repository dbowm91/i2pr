...
plans/closure/ntcp2-transport/063-status.md
```
...
- `plans/closure/ntcp2-transport/063-status.md` records implementation commit and receipt digest without claiming mixed-router i2pr success.
