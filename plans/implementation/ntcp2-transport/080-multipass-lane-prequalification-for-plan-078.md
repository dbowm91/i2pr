...
- Closure record: `plans/closure/ntcp2-transport/080-status.md`.
...
If WP4 produces `qualified = true`, update `plans/closure/ntcp2-transport/078-status.md` from
...
Write `plans/closure/ntcp2-transport/080-status.md` with the exact selected lane, qualification
record digest, run ID, commands, results, and any typed blocker. Update
`plans/closure/ntcp2-transport/078-status.md` to reflect the qualified lane or the remaining
blocker. Flip
...
- `plans/implementation/ntcp2-transport/080-multipass-lane-prequalification-for-plan-078.md` (this file)
- `plans/closure/ntcp2-transport/080-status.md` (closure record)
