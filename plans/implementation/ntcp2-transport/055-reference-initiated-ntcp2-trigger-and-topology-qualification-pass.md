...
18. `plans/closure/ntcp2-transport/055-status.md` records selected seams/topology, exact revisions, controls, and outcomes.
...
- `plans/closure/ntcp2-transport/055-status.md`.
