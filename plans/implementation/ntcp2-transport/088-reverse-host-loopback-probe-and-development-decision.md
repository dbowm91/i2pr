...
Do not start unless `plans/closure/ntcp2-transport/087-status.md` binds:
...
Write `plans/closure/ntcp2-transport/088-status.md` with exactly one decision.
...
Plan 079 becomes executable only when `plans/closure/ntcp2-transport/088-status.md` records exactly:
...
- `plans/closure/ntcp2-transport/088-status.md` with one exact decision;
...
Use the actual current reverse-test filename when the repository keeps reverse tests in `test_plan084.py` rather than a separate module. Record the exact live command and result digests in `plans/closure/ntcp2-transport/088-status.md`.
...
8. Write one exact decision in `plans/closure/ntcp2-transport/088-status.md`.
