...
8. `plans/closure/ntcp2-transport/088-status.md` is stale and still describes Plan 086 as unclosed and Plan 087 as unexecuted.
...
`plans/closure/ntcp2-transport/087-status.md` must:
...
`plans/closure/ntcp2-transport/088-status.md` must immediately stop claiming that Plan 086 is unclosed or that Plan 087 never executed. Before the Plan 087 pass it must accurately state:
...
6. rewrite the stale pre-execution portion of `plans/closure/ntcp2-transport/088-status.md`.
...
1. Update `plans/closure/ntcp2-transport/087-status.md` with exact committed-head evidence.
2. Update `plans/closure/ntcp2-transport/088-status.md` to reflect a satisfied forward gate.
...
- [ ] `plans/closure/ntcp2-transport/087-status.md` records `status = passed` with exact evidence.
- [ ] `plans/closure/ntcp2-transport/088-status.md` no longer contains stale Plan 086/087 claims and records the forward gate as satisfied.
