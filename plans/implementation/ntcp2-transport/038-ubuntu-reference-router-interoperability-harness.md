...
- `plans/closure/ntcp2-transport/036-m3-interoperability-adversarial-validation-closure.md`
...
Create `plans/closure/ntcp2-transport/038-closure.md` containing:
...
13. `plans/closure/ntcp2-transport/038-closure.md` exists and accurately states remaining blockers.
...
Only after those results exist may `plans/closure/ntcp2-transport/030-milestone-3-closure.md` be rewritten from blocked to complete and Milestone 4 planning begin.
