...
plans/closure/ntcp2-transport/086-status.md
```
...
- `plans/closure/ntcp2-transport/086-status.md` records exact commands and focused test results.
...
6. Write `plans/closure/ntcp2-transport/086-status.md`.
