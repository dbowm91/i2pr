...
- The Plan 078/080 attempt stopped pre-protocol and cannot satisfy this prerequisite; see `plans/implementation/ntcp2-transport/080-diagnostic-correction-amendment-plan-081.md`.
...
Plan 079 must not begin unless `plans/closure/ntcp2-transport/084-status.md` records exactly:
