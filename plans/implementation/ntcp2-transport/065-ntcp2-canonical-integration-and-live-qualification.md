...
plans/closure/ntcp2-transport/065-status.md
specs/support.toml
```
...
`plans/closure/ntcp2-transport/065-status.md` must record:
...
- `plans/closure/ntcp2-transport/065-status.md` records exact implementation floor and bundle digest;
