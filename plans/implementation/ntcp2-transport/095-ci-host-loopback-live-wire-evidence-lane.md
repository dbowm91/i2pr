...
### Rewrite `plans/closure/ntcp2-transport/087-status.md`
...
### Rewrite `plans/closure/ntcp2-transport/088-status.md`
...
- [ ] `plans/closure/ntcp2-transport/087-status.md` records `status = passed` with both exact forward digests.
