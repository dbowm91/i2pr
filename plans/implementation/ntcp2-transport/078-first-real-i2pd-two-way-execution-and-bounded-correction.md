...
- Status: closed-as-blocked-protocol-defect (2026-08-01: i2pr-side pre-protocol RouterInfo failure inside the qualified Plan 080 Multipass lane; see `plans/closure/ntcp2-transport/080-status.md` and `target/interop/evidence/multipass/plan080-20260801034138-c8bec3f5/directions/i2pr-to-i2pd-ipv4.json`).
...
Create `plans/closure/ntcp2-transport/078-status.md` with:
