...
A typed blocker may be recorded in `plans/closure/ntcp2-transport/048-status.md`, but it does not satisfy this plan's environment-creation or protocol-evidence objective.
