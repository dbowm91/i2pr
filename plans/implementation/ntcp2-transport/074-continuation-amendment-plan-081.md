...
- Applies to `plans/implementation/ntcp2-transport/074-milestone-3-real-driver-and-constrained-host-corrective-roadmap.md`.
- Successor roadmap: `plans/implementation/ntcp2-transport/081-milestone-3-pre-protocol-and-minimal-i2pd-corrective-roadmap.md`.
...
```text
plans/implementation/ntcp2-transport/067-active-sequence-amendment-plan-081.md
