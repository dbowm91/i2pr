...
plans/closure/ntcp2-transport/099-status.md
...
Record the exact commit SHA in `plans/closure/ntcp2-transport/099-status.md` as:
...
`plans/closure/ntcp2-transport/099-status.md` must carry exactly the active outcome and the retained compact result identity.

It must not say Plan 095 remains the next executable plan.

### 10.2 Plans 087/088 become historical execution authority

Add an active correction at the top of `plans/closure/ntcp2-transport/087-status.md` and `plans/closure/ntcp2-transport/088-status.md` stating that Plan 099/100 supersede their Plan 095 sequencing for development execution.
...
51. `plans/closure/ntcp2-transport/099-status.md` no longer claims Plan 099 is fully passed before its final run result exists.
