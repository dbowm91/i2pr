...
- Status: planned-conditional. **Inactive on 2026-08-01.** See the activation
  amendment at
  [`plans/implementation/ntcp2-transport/072-activation-amendment-plan-084.md`](072-activation-amendment-plan-084.md)
  ...
  `plans/closure/ntcp2-transport/084-status.md` records
