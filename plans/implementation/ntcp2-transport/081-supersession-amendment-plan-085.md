...
- Applies to `plans/implementation/ntcp2-transport/081-milestone-3-pre-protocol-and-minimal-i2pd-corrective-roadmap.md` and its Plans 082-084 sequence.
- Successor authority: Plan 085 and `plans/implementation/ntcp2-transport/067-active-sequence-amendment-plan-085.md`.
