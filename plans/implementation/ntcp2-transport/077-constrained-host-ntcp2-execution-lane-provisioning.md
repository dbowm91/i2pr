...
and at closure document sanitized results in `plans/closure/ntcp2-transport/077-status.md`.
...
Create `plans/closure/ntcp2-transport/077-status.md` with exact selected lane and commands. Do not claim NTCP2 interoperability.
