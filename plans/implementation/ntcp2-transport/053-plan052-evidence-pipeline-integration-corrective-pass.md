...
- Depends on:
  - `plans/closure/ntcp2-transport/052-ntcp2-milestone-3-evidence-closure-follow-up.md`;
  - `plans/closure/ntcp2-transport/052-status.md`;
...
18. `plans/closure/ntcp2-transport/053-status.md` records exact commits, tests, and known remaining external blockers.
...
- `plans/closure/ntcp2-transport/053-status.md`;
