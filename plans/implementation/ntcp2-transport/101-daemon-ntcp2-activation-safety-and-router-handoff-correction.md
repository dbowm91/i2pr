...
Update `plans/closure/ntcp2-transport/099-status.md` with a short correction note:
...
3. Read the final section of `plans/closure/ntcp2-transport/099-status.md` and the top active blocks of Plans 087/088.
