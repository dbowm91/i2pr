...
6. `plans/closure/ntcp2-transport/087-status.md` contains stale/inconsistent authority text, including historical Plan 092 next-executable statements and a stray `plan_093b` token that must not remain part of the canonical gate vocabulary.
7. `plans/closure/ntcp2-transport/088-status.md` contains stale Plan 092 gate text and historical lane wording that must be reconciled before Plan 088 becomes executable.
...
2. Read Plan 093, `plans/closure/ntcp2-transport/087-status.md`, `plans/closure/ntcp2-transport/088-status.md`, `plans/closure/ntcp2-transport/091-status.md`, and `plans/closure/ntcp2-transport/092-status.md`.
...
```text
plans/closure/ntcp2-transport/087-status.md
plans/closure/ntcp2-transport/088-status.md
plans/closure/ntcp2-transport/091-status.md       # only if it still claims active authority
plans/closure/ntcp2-transport/092-status.md       # only if it still claims active authority
README.md
AGENTS.md
...
Rewrite `plans/closure/ntcp2-transport/087-status.md` current authority to:
...
Rewrite `plans/closure/ntcp2-transport/088-status.md` current authority to:
...
- [ ] `plans/closure/ntcp2-transport/087-status.md` records `status = passed`.
- [ ] `plans/closure/ntcp2-transport/088-status.md` records `decision = not-yet-run` and `plan_088 = next_executable`.
