...
- Status: implemented (reverse-direction record schema, focused test
  ...
  ``lane-invalidated``; see ``plans/closure/ntcp2-transport/084-status.md`` for the
...
Create `plans/closure/ntcp2-transport/084-status.md` with one of the following exact decisions.
...
Record the exact live command and result digest in `plans/closure/ntcp2-transport/084-status.md`.
