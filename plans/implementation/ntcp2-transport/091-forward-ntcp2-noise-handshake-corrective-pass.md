...
8. `plans/closure/ntcp2-transport/087-status.md` and `plans/closure/ntcp2-transport/088-status.md` still contain stale historical sections and contradictory gate statements.
...
1. update `plans/closure/ntcp2-transport/087-status.md` to one current authoritative closure section;
2. set exactly:
...
7. rewrite `plans/closure/ntcp2-transport/088-status.md` so its entry gate states that Plan 087 passed and Plan 088 is the next executable plan;
...
- [ ] `plans/closure/ntcp2-transport/087-status.md` records `status = passed` without stale contradictory sections.
- [ ] `plans/closure/ntcp2-transport/088-status.md` records Plan 088 as next executable without claiming reverse success.
