...
Plan 046 does not advertise NTCP2 support and does not close Milestone 3 by itself. Milestone 3 remains open until successful retained evidence is separately reviewed against `plans/implementation/workspace-foundation/000-mvp-roadmap.md`, `plans/implementation/ntcp2-transport/030-milestone-3-overview.md`, and `specs/CONFORMANCE.md`.
...
- `plans/closure/ntcp2-transport/045-ntcp2-mixed-router-proof-closure-corrective-pass.md`
...
```text
plans/closure/ntcp2-transport/046-status.md
```
...
- add `plans/closure/ntcp2-transport/046-status.md`;
