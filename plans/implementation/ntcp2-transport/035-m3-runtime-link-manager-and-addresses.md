...
- `plans/closure/ntcp2-transport/031-closure.md` defines the transport-neutral contracts.
- `plans/closure/ntcp2-transport/032-closure.md` validates cryptographic dependencies and transcript vectors.
- `plans/closure/ntcp2-transport/033-closure.md` validates complete pure handshake state machines.
- `plans/closure/ntcp2-transport/034-closure.md` validates pure authenticated data-phase framing and blocks.
...
Create `plans/closure/ntcp2-transport/035-closure.md` containing:
...
- `plans/closure/ntcp2-transport/035-closure.md` exists.
