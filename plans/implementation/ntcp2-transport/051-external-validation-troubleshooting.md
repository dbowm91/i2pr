...
`plans/implementation/ntcp2-transport/030-milestone-3-overview.md` lists the exit criteria. The
...
`plans/closure/ntcp2-transport/030-milestone-3-closure.md` records the current closure status:
...
`plans/closure/ntcp2-transport/030-milestone-3-closure.md` can then be amended to record
