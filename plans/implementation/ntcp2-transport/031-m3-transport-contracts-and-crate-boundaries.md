...
- `plans/closure/workspace-foundation/025-closure.md` exists and remains satisfied.
- `plans/implementation/ntcp2-transport/030-milestone-3-overview.md` is the controlling milestone document.
...
Create `plans/closure/ntcp2-transport/031-closure.md` with:
