...
17. `plans/closure/ntcp2-transport/054-status.md` records matrix results, selected model, exact markers, exact revisions, tests, and remaining blockers.
...
- `plans/closure/ntcp2-transport/054-status.md`.
