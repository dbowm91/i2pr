...
- Parent roadmap: `plans/implementation/ntcp2-transport/067-milestone-3-staged-interoperability-corrective-roadmap.md`.
- Supersedes the active execution authority of `plans/implementation/ntcp2-transport/067-active-sequence-amendment-plan-081.md`.
- Active successor roadmap: `plans/implementation/ntcp2-transport/085-milestone-3-host-loopback-development-execution-roadmap.md`.
...
- write `plans/closure/ntcp2-transport/086-status.md`.

Do not execute Plan 087 in the same commit.

## Plan 087 entry rule

Plan 087 begins only when `plans/closure/ntcp2-transport/086-status.md` records:
...
Plan 088 begins only when `plans/closure/ntcp2-transport/087-status.md` records a passing instrumented forward result and behavior-neutral control comparison.

## Plan 079 unblock rule

Plan 079 becomes executable only when `plans/closure/ntcp2-transport/088-status.md` records:
...
Plan 072 may be activated only when `plans/closure/ntcp2-transport/088-status.md` records:
...
plans/closure/ntcp2-transport/030-milestone-3-closure.md or a dated active amendment
```
...
```text
plans/implementation/ntcp2-transport/085-milestone-3-host-loopback-development-execution-roadmap.md
plans/implementation/ntcp2-transport/086-status-authority-and-host-loopback-development-lane.md
plans/closure/ntcp2-transport/083-084-execution-status-amendment-plan-085.md
plans/implementation/ntcp2-transport/067-active-sequence-amendment-plan-085.md
```
