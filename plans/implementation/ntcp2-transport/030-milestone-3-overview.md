...
- `plans/closure/workspace-foundation/010-milestone-1-closure.md`
- `plans/closure/workspace-foundation/020-milestone-2-closure.md`
- `plans/closure/workspace-foundation/025-closure.md`
...
1. `plans/implementation/ntcp2-transport/031-m3-transport-contracts-and-crate-boundaries.md`
2. `plans/implementation/ntcp2-transport/032-m3-ntcp2-crypto-transcript-and-vectors.md`
3. `plans/implementation/ntcp2-transport/033-m3-ntcp2-handshake-state-machines.md`
4. `plans/implementation/ntcp2-transport/034-m3-ntcp2-data-phase-and-blocks.md`
5. `plans/implementation/ntcp2-transport/035-m3-runtime-link-manager-and-addresses.md`
6. `plans/closure/ntcp2-transport/036-m3-interoperability-adversarial-validation-closure.md`
...
```text
plans/closure/ntcp2-transport/031-closure.md
plans/closure/ntcp2-transport/032-closure.md
plans/closure/ntcp2-transport/033-closure.md
plans/closure/ntcp2-transport/034-closure.md
plans/closure/ntcp2-transport/035-closure.md
plans/closure/ntcp2-transport/036-closure.md
```
...
- `plans/closure/ntcp2-transport/030-milestone-3-closure.md` exists with exact interoperability and CI evidence.
