...
- Prior corrective roadmap: `plans/implementation/ntcp2-transport/074-milestone-3-real-driver-and-constrained-host-corrective-roadmap.md`.
- Active successor roadmap: `plans/implementation/ntcp2-transport/081-milestone-3-pre-protocol-and-minimal-i2pd-corrective-roadmap.md`.
...
plans/closure/ntcp2-transport/030-milestone-3-closure.md or an active amendment
plans/implementation/ntcp2-transport/079-repeated-i2pd-development-validation-and-continuation-decision.md
```
...
Plan 079 becomes executable only when `plans/closure/ntcp2-transport/084-status.md` records:
...
Plan 072 may be activated only when `plans/closure/ntcp2-transport/084-status.md` records:
...
```text
plans/implementation/ntcp2-transport/081-milestone-3-pre-protocol-and-minimal-i2pd-corrective-roadmap.md
plans/implementation/ntcp2-transport/082-i2pr-state-preparation-and-mixed-runner-contract-correction.md
plans/implementation/ntcp2-transport/080-diagnostic-correction-amendment-plan-081.md
```
