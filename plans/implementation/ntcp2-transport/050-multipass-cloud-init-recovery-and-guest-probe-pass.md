...
- `plans/implementation/ntcp2-transport/046-rootless-sealed-namespace-evidence-lane.md`
- `plans/implementation/ntcp2-transport/047-cross-host-rootless-lane-expansion.md`
- `plans/implementation/ntcp2-transport/048-multipass-permissive-rootless-evidence-environment.md`
- `plans/closure/ntcp2-transport/048-status.md`
- `plans/implementation/ntcp2-transport/049-multipass-lifecycle-ownership-corrective-pass.md`
- `plans/closure/ntcp2-transport/049-status.md`
- `plans/closure/ntcp2-transport/049-closure.md`
...
- `plans/closure/ntcp2-transport/050-status.md` with exact commands and typed outcomes;
- `plans/closure/ntcp2-transport/050-closure.md` only if the stated local or external criteria are met and clearly distinguished;
