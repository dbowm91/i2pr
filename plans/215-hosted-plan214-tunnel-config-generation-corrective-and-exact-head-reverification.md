...
Record that exact SHA in `plans/215-status.md` as:
...
1. update `plans/215-status.md` with:
...
2. update `plans/214-status.md` to the passed final application authority;
...
36. `plans/215-status.md` records both run IDs and the tested SHA.
