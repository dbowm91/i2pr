...
| 204 | blocked | blocked-on-m6-java-second-family-closure-pending-plan228 | — | `plans/closure/service-tunnels/204-m10-final-closure-evidence-authority-and-documentation-normalization.md`; `plans/closure/service-tunnels/204-status.md` |
...
Full row history is §7. Current authority: Plan 215 remains M10 product authority; Plan 204 convergence remains blocked on M6 Java second-family closure while Plan 228 performs attribution-only client-tunnel build-path diagnosis.
