...
| 204 | blocked | blocked-on-m6-java-second-family-closure-pending-plan232 | — | `plans/closure/service-tunnels/204-m10-final-closure-evidence-authority-and-documentation-normalization.md`; `plans/closure/service-tunnels/204-status.md` |
...
- Plan 204 convergence is deferred until independent M6 Java second-family closure; Plan 231 closed the post-`ACCEPTED` attribution with the lease-fixture root cause and Plan 232 now owns the route-derived fixture correction plus Java continuation. Neither reopens or downgrades M10 product closure.
...
Open: Plan 204 docs/CI normalization convergence over the independently closed M10 authority plus the M6 Java second-family row. Plan 231 closed the exact target-IBGW boundary; Plan 232 is registered-ready to correct the route-derived lease fixture and continue raw Destination + Streaming qualification; convergence remains blocked until Java-family qualification closes M6.

## 12. Milestone status summary

Full row history is §7. Current authority: Plan 215 remains M10 product authority; Plan 204 convergence remains blocked on M6 Java second-family closure while Plan 232 executes the M6-only route-derived lease-gateway corrective/continuation.
