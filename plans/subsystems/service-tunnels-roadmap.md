...
Plan 215 (`passed-m10-hosted-plan214-tunnel-config-generation-corrective-and-exact-head-reverification`) is the closed M10 product authority. Plan 204 is convergence-only and remains blocked on independent M6 Java second-family closure. Plan 236 closed at `P236-C-JAVA-RESPONSE-EMISSION-OBSERVABILITY-GAP`; Plan 237 is registered-ready for the narrow stock-Java response-observability corrective. None of Plans 231-237 changes closed M10 product authority.
...
| 204 | blocked | blocked-on-m6-java-second-family-closure-pending-plan239 | — | `plans/closure/service-tunnels/204-m10-final-closure-evidence-authority-and-documentation-normalization.md`; `plans/closure/service-tunnels/204-status.md` |
...
- Plan 204 convergence is deferred until independent M6 Java second-family closure; Plan 236 closed at the response-emission observability gap; Plan 237 closed at the Router-A I2CP-not-observed boundary with sendMessage-return proven; Plan 238 closed at the Client-Message-Not-Admitted boundary with admission proven and dispatch absence proven. Plan 239 owns the narrow Router-A dispatch observer corrective. None reopens or downgrades M10 product closure.
...
Open: Plan 204 docs/CI normalization convergence over the independently closed M10 authority plus the M6 Java second-family row. Plan 236 closed at the response-emission observability gap; Plan 237 closed at the Router-A boundary with Plan 238 registered; Plan 238 closed at the dispatch boundary with Plan 239 registered. Convergence remains blocked until Java-family qualification closes M6.

## 12. Milestone status summary

Full row history is §7. Current authority: Plan 215 remains M10 product authority; Plan 204 convergence remains blocked on M6 Java second-family closure pending Plan 239.
