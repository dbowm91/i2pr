...
Historic/registered plans: 183–194, 196–198, 200, 201, 205, 217–232 (global i2pr numbers, preserved).
...
Plan 232 is registered-ready as the narrow fixture corrective and continuation. It derives the local LS2 lease gateway and gateway tunnel from the installed inbound route rather than from `java_hash`; the same correction is required at all three current Java-driver local lease sites (raw Destination, initial Streaming, Streaming refresh). Router B remains the independent NetDB publication target. After route parity is proven, Plan 232 reruns raw Destination and, if reverse delivery passes, continues directly through the existing Java Streaming qualification so Java second-family M6 may close without another ceremonial plan.
...
```text
183 -> 184 -> 185 -> 186 -> 187 -> 188 -> 190 -> 191 -> 192 -> 193 -> 196 -> 197 -> 194 -> 198 -> 200 -> 201 -> 217 -> 218 -> 219 -> 220 -> 221 -> 222 -> 223 -> 224 -> 225 -> 226 -> 227 -> 228 -> 229 -> 230 -> 231 -> 232. Plan 205 is retained conditional fallback and is not part of the primary sequence.
```
...
| 201 | blocked | blocked-pending-plan232-route-derived-lease-gateway-fixture-corrective | — | `plans/closure/mixed-router-interop/201-m6-java-public-client-publication-corrective-and-second-family-closure.md`; `plans/closure/mixed-router-interop/201-status.md` |
...
| 232 | ready | registered-ready-m6-java-route-derived-lease-gateway-fixture-corrective-and-second-family-closure | `plans/implementation/mixed-router-interop/232-m6-java-route-derived-lease-gateway-fixture-corrective-and-second-family-closure.md` | `plans/closure/mixed-router-interop/232-status.md` |
