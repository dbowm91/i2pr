...
Historic/registered plans: 183–194, 196–198, 200, 201, 205, 217–239 (global i2pr numbers, preserved).
...
```text
183 -> 184 -> 185 -> 186 -> 187 -> 188 -> 190 -> 191 -> 192 -> 193 -> 196 -> 197 -> 194 -> 198 -> 200 -> 201 -> 217 -> 218 -> 219 -> 220 -> 221 -> 222 -> 223 -> 224 -> 225 -> 226 -> 227 -> 228 -> 229 -> 230 -> 231 -> 232 -> 233 -> 234 -> 235 -> 236 -> 237 -> 238 -> 239. Plan 205 is retained conditional fallback and is not part of the primary sequence.
```
...
| 201 | blocked | blocked-after-plan237-router-i2cp-not-observed-pending-router-a-observer-and-publication-closure | — | `plans/closure/mixed-router-interop/201-m6-java-public-client-publication-corrective-and-second-family-closure.md`; `plans/closure/mixed-router-interop/201-status.md` |
...
| 239 | ready | registered-ready-m6-java-streaming-router-a-dispatch-observer | `plans/implementation/mixed-router-interop/239-m6-java-streaming-router-a-dispatch-observer.md` | — |
