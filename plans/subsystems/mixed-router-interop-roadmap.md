...
Historic/registered plans: 183–194, 196–198, 200, 201, 205, 217–234 (global i2pr numbers, preserved).
...
Plan 234 is closed at Outcome B with `P234-B-JAVA-ACCEPTED-NO-RESPONSE-OBSERVED`: the Java accept worker returned and stored a socket, but no i2pr inbound TunnelData appeared in the frozen SYN epoch. The retained Plan-232 raw-Destination reverse pass remains authoritative. Plan 235 is the ready successor for the exact post-accept/pre-i2pr-inbound response boundary; Java-family M6 remains not-yet-passed.
...
```text
183 -> 184 -> 185 -> 186 -> 187 -> 188 -> 190 -> 191 -> 192 -> 193 -> 196 -> 197 -> 194 -> 198 -> 200 -> 201 -> 217 -> 218 -> 219 -> 220 -> 221 -> 222 -> 223 -> 224 -> 225 -> 226 -> 227 -> 228 -> 229 -> 230 -> 231 -> 232 -> 233 -> 234 -> 235. Plan 205 is retained conditional fallback and is not part of the primary sequence.
```
...
| 201 | blocked | blocked-pending-plan235-java-streaming-post-accept-response-boundary-corrective | — | `plans/closure/mixed-router-interop/201-m6-java-public-client-publication-corrective-and-second-family-closure.md`; `plans/closure/mixed-router-interop/201-status.md` |
