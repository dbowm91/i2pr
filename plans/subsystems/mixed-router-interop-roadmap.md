...
Historic/registered plans: 183–194, 196–198, 200, 201, 205, 217–233 (global i2pr numbers, preserved).
...
Plan 233 is registered-ready as the narrow Streaming SYN-ACK corrective
on the corrected fixture. It must not relitigate the closed
lease-gateway correction.
...
```text
183 -> 184 -> 185 -> 186 -> 187 -> 188 -> 190 -> 191 -> 192 -> 193 -> 196 -> 197 -> 194 -> 198 -> 200 -> 201 -> 217 -> 218 -> 219 -> 220 -> 221 -> 222 -> 223 -> 224 -> 225 -> 226 -> 227 -> 228 -> 229 -> 230 -> 231 -> 232 -> 233. Plan 205 is retained conditional fallback and is not part of the primary sequence.
```
...
| 201 | blocked | blocked-pending-plan233-streaming-syn-ack-corrective-after-plan232-raw-reverse-pass | — | `plans/closure/mixed-router-interop/201-m6-java-public-client-publication-corrective-and-second-family-closure.md`; `plans/closure/mixed-router-interop/201-status.md` |
...
| 233 | ready | registered-ready-m6-java-streaming-syn-ack-corrective-after-route-derived-lease-fix | `plans/implementation/mixed-router-interop/233-m6-java-streaming-syn-ack-corrective-after-route-derived-lease-fix.md` | `plans/closure/mixed-router-interop/233-status.md` |
