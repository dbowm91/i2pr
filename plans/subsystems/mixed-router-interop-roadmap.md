...
Plan 230 is registered-ready as the bounded attribution for that
profile-population boundary. It observes, through ordinary stock-Java
activity only, how (and whether) the controlled topology populates the
tier population; profile injection stays forbidden.
...
| 201 | blocked | blocked-pending-plan230-profile-population-path-attribution-after-plan229-not-eligible | — | `plans/closure/mixed-router-interop/201-m6-java-public-client-publication-corrective-and-second-family-closure.md`; `plans/closure/mixed-router-interop/201-status.md` |
...
| 230 | ready | registered-ready-m6-java-profile-population-path-attribution | `plans/implementation/mixed-router-interop/230-m6-java-profile-population-path-attribution.md` | `plans/closure/mixed-router-interop/230-status.md` |
