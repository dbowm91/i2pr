...
Plan 234 is closed at Outcome B with `P234-B-JAVA-ACCEPTED-NO-RESPONSE-OBSERVED`. Plan 235 is also closed at Outcome B with `P235-B-JAVA-SOCKET-SURFACE-READY-NO-I2PR-INBOUND`: Java's public socket surface was ready and i2pr admitted the outbound SYN, but no inbound TunnelData appeared. Plan 236 closed at `P236-C-JAVA-RESPONSE-EMISSION-OBSERVABILITY-GAP` after source-locking the exact stock-Java response path and reproducing the absence of bounded scheduler/PacketQueue/I2PSession observation on two same-SHA attempts. Router-A and i2pr-owned attribution were not attempted. The retained Plan-232 raw-Destination reverse pass remains authoritative; Java-family M6 remains not-yet-passed.
...
| 201 | blocked | blocked-after-plan236-java-response-emission-observability-gap | — | `plans/closure/mixed-router-interop/201-m6-java-public-client-publication-corrective-and-second-family-closure.md`; `plans/closure/mixed-router-interop/201-status.md` |
