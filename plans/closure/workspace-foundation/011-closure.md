...
This record closes `plans/implementation/workspace-foundation/011-m1-codec-foundation.md`. The change is limited
...
- `AGENTS.md`, `README.md`, and `docs/architecture.md` — document the codec
  ...
  status.
- `plans/closure/workspace-foundation/011-closure.md` — this durable handoff and closure record.
