...
1. `README.md`
2. `GUARDRAILS.md`
3. `plans/implementation/workspace-foundation/000-mvp-roadmap.md`
4. `plans/implementation/workspace-foundation/001-preplan-workspace-skeleton.md`
...
Add `plans/closure/workspace-foundation/001-closure.md` or append a clearly marked closure section to the existing pre-plan. It must record:
