...
- `plans/closure/workspace-foundation/022-closure.md`
- `plans/closure/workspace-foundation/023-closure.md`
- `plans/closure/workspace-foundation/024-m2-observability-validation-closure.md`
...
- `plans/closure/workspace-foundation/020-milestone-2-closure.md`: mark the prior closure as corrected/superseded where necessary and link the corrective record.
...
Also run a deterministic repeated lane for the forced-child cleanup and uncancelled essential completion tests. Record the exact command and number of repetitions in `plans/closure/workspace-foundation/025-closure.md`.
...
- `plans/closure/workspace-foundation/025-closure.md` exists and records exact evidence.
- `plans/closure/workspace-foundation/020-milestone-2-closure.md` links the corrective closure and no longer presents superseded cleanup wording as final.
...
The Milestone 3 handoff must cite `plans/closure/workspace-foundation/025-closure.md` as a prerequisite and must not duplicate or bypass these lifecycle contracts.