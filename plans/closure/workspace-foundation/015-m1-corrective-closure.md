...
- `GUARDRAILS.md`
- `plans/implementation/workspace-foundation/010-milestone-1-overview.md`
- `plans/implementation/workspace-foundation/011-m1-codec-foundation.md`
- `plans/implementation/workspace-foundation/012-m1-common-structures.md`
- `plans/implementation/workspace-foundation/013-m1-identity-crypto-storage.md`
- `plans/closure/workspace-foundation/014-m1-i2np-evidence-fuzzing-closure.md`
- `plans/closure/workspace-foundation/011-closure.md` through `plans/closure/workspace-foundation/014-closure.md`
...
- Align `docs/protocol-support.md` milestone numbers with `plans/implementation/workspace-foundation/000-mvp-roadmap.md`: minimal streaming belongs to Milestone 6, SAM to 7, SSU2 to 8, I2CP to 9, and service tunnels to 10.
...
Create `plans/closure/workspace-foundation/010-milestone-1-closure.md` after all corrective work is complete.
