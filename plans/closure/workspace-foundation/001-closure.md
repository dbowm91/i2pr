...
`plans/closure/workspace-foundation/002-milestone-0-corrective-closure.md`. The pass remains bounded to
...
- `plans/closure/workspace-foundation/001-closure.md` — this closure record;
