...
Plan of record:
[`plans/implementation/i2cp/164-m9-i2cp-protocol-and-wire-foundation.md`](../../implementation/i2cp/164-m9-i2cp-protocol-and-wire-foundation.md).
...
(`plans/implementation/i2cp/165-m9-i2cp-connection-session-and-options.md`) next, then
