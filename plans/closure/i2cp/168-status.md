...
Plan of record:
[`plans/implementation/i2cp/168-m9-i2cp-message-data-plane.md`](../../implementation/i2cp/168-m9-i2cp-message-data-plane.md).
...
15. `plans/closure/i2cp/168-status.md` records exact local evidence and states
...
- `AGENTS.md` — adds the Plan 168 current authority row, advances
  the M9 reading order to start at `plans/closure/i2cp/168-status.md`, adds
