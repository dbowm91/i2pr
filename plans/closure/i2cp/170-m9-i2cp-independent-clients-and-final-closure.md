...
```text
plans/closure/i2cp/170-status.md
plans/README.md
README.md
AGENTS.md
...
25. `plans/closure/i2cp/170-status.md` records exact closing SHA, workflow run IDs, external pins, commands, artifact identifiers/digests, and final classification.
