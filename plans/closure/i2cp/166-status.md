...
Plan of record:
[`plans/implementation/i2cp/166-m9-i2cp-client-owned-destination-and-leaseset2.md`](../../implementation/i2cp/166-m9-i2cp-client-owned-destination-and-leaseset2.md).
...
13. workspace floor and exact-head CI pass — see the local floor
    above;
14. `plans/closure/i2cp/166-status.md` records evidence and the ownership
    invariant — this file.
...
- `AGENTS.md` — Plan 166 added to the current authority, advanced
  the M9 reading order to start at `plans/closure/i2cp/166-status.md`, added
...
([`plans/implementation/i2cp/167-m9-i2cp-loopback-server-runtime.md`](../../implementation/i2cp/167-m9-i2cp-loopback-server-runtime.md))
