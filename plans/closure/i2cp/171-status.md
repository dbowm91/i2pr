...
Plan of record:
[`plans/implementation/i2cp/171-m9-i2cp-invalid-preamble-close-and-ci-corrective.md`](../../implementation/i2cp/171-m9-i2cp-invalid-preamble-close-and-ci-corrective.md).
