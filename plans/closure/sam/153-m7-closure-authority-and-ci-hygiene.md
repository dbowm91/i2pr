...
```toml
plan_152_closure = "plans/closure/sam/152-status.md"
```
...
2. Create `plans/closure/sam/152-status.md` from actual executed evidence, not reconstructed assumptions.
...
11. Only after both hosted lanes pass, mark `plans/closure/sam/153-status.md` passed and advance executable authority to Plan 155.
...
1. `plans/closure/sam/152-status.md` exists and is the authoritative Plan 152 closure record.
2. `specs/support.toml` points to `plans/closure/sam/152-status.md`.
...
17. `plans/closure/sam/153-status.md` records exact closing SHA and hosted run IDs/results.
