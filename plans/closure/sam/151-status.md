...
Plan of record:
[`plans/implementation/sam/151-m7-sam31-final-acceptance-evidence-correction.md`](../../implementation/sam/151-m7-sam31-final-acceptance-evidence-correction.md).
...
- Plan 151 §17 stop fired during this work: the new tests exposed
  ...
  [`plans/implementation/sam/152-m6-session-streaming-robustness-corrective.md`](../../implementation/sam/152-m6-session-streaming-robustness-corrective.md);
...
~~Execute `plans/implementation/sam/151-m7-sam31-final-acceptance-evidence-correction.md`.~~
