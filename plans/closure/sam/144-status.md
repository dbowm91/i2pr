...
Plan of record:
[`plans/closure/sam/144-m7-sam31-independent-client-final-closure-corrective.md`](144-m7-sam31-independent-client-final-closure-corrective.md).
...
- `plans/README.md` — Plan 144 row reclassified as
  ...
  reference to `plans/closure/sam/144-status.md` added.
