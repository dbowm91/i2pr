...
> **Current authority:** Plan 140 remains the audit record that discovered the blocked Milestone 7 closure. Its next-action guidance is superseded by [`plans/closure/sam/141-status.md`](141-status.md) and the Plan 142 → 143 → 144 corrective sequence. Historical findings below remain evidence.
...
The current corrective classification is in `plans/closure/sam/141-status.md`.
