...
Plan of record:
[`plans/closure/sam/153-m7-closure-authority-and-ci-hygiene.md`](153-m7-closure-authority-and-ci-hygiene.md).
...
1. Created the missing authoritative Plan 152 closure record
   [`plans/closure/sam/152-status.md`](152-status.md)
...
4. Added `plan_152_closure = "plans/closure/sam/152-status.md"` to
