...
- **Strict SAM Base64 codec** (`crates/i2pr-api/src/sam/base64.rs`).
  ...
  See [`plans/closure/sam/142-status.md`](142-status.md) for the closure
  record.
...
8. At least one independently derived/frozen private-destination fixture
   ...
   `crates/i2pr-api/tests/`. See [`plans/closure/sam/142-status.md`](142-status.md)
...
14. This status file is committed at `plans/closure/sam/136-status.md` —
    **satisfied** (this file).
