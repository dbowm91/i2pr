...
plans/closure/sam/148-status.md
AGENTS.md
specs/support.toml
...
22. `plans/closure/sam/148-status.md` closes Milestone 7 and sets Milestone 8 as next only after all above pass.
...
Record exact commands and pass counts in `plans/closure/sam/148-status.md`.
