...
Plan of record:
[`plans/implementation/sam/146-m7-sam31-private-destination-reference-requalification.md`](../../implementation/sam/146-m7-sam31-private-destination-reference-requalification.md).

Source audit: Plan 145 (`active-m7-sam31-corrective-roadmap`),
[`plans/closure/sam/145-status.md`](145-status.md).
