...
Plan of record:
[`plans/implementation/sam/149-m7-sam31-self-composing-local-product-corrective.md`](../../implementation/sam/149-m7-sam31-self-composing-local-product-corrective.md).

Newest final Milestone 7 acceptance authority:
[`plans/closure/sam/151-status.md`](151-status.md).
...
[`Plan 151`](../../implementation/sam/151-m7-sam31-final-acceptance-evidence-correction.md) to close the
