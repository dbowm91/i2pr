...
Plan of record: [`plans/closure/sam/148-m7-sam31-independent-client-final-closure.md`](148-m7-sam31-independent-client-final-closure.md).

Current corrective authority: [`plans/closure/sam/150-status.md`](150-status.md).
