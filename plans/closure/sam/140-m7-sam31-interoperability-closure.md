...
Create `plans/closure/sam/140-status.md` with exact evidence and update `plans/closure/sam/135-status.md` to closed/superseded-by-M7 status.
...
[ ] plans/closure/sam/140-status.md is committed
[ ] next_product_layer = Milestone 8 / SSU2 planning
```
