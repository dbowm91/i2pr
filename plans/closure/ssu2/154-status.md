...
Plan of record:
[`plans/implementation/ssu2/154-m8-ssu2-transport-and-reachability-roadmap.md`](../../implementation/ssu2/154-m8-ssu2-transport-and-reachability-roadmap.md).
...
`plans/closure/sam/153-status.md` is `passed-post-m7-authority-and-ci-hygiene`; the original
...
direct-interop scope (see `plans/closure/ssu2/161-status.md` for the criterion
