...
Also run named final local real-UDP, migration, peer-test and relay suites from Plans 158–160 and record their exact commands in `plans/closure/ssu2/161-status.md`.
...
24. only after 1–23 pass does `plans/closure/ssu2/161-status.md` set Milestone 8 closed and `next_product_layer = milestone9-planning`.
