...
Plan of record:
[`plans/closure/ssu2/161-m8-ssu2-independent-ipv4-interop-and-final-closure.md`](161-m8-ssu2-independent-ipv4-interop-and-final-closure.md).

Temporary corrective authority:
[`plans/implementation/ssu2/162-m8-ssu2-external-test-lane-isolation-and-ci-restoration.md`](../../implementation/ssu2/162-m8-ssu2-external-test-lane-isolation-and-ci-restoration.md).
