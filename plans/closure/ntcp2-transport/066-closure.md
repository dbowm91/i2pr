...
(`plans/closure/ntcp2-transport/066-candidate.md`). The Plan 066 plan-of-record explicitly
...
| Prerequisite | Status |
| --- | --- |
| Plan 060 candidate retired | Yes (`plans/closure/ntcp2-transport/060-candidate.md` declares `retired; retired by Plan 062`) |
| Plan 056 candidate retired | Yes (`plans/closure/ntcp2-transport/056-candidate.md` declares retired status) |
| Plan 057 superseded | Yes (`plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md` declares superseded status) |
...
| Plan 065 plan-of-record | Yes (`plans/implementation/ntcp2-transport/065-ntcp2-canonical-integration-and-live-qualification.md`) |
| Plan 065 closure record | Yes (`plans/closure/ntcp2-transport/065-status.md`) |
...
| Plan 060 typed-blocker marker | Yes (`blocked_execution_lane_unavailable` recorded on `plans/closure/ntcp2-transport/060-candidate.md`) |
...
- `plans/closure/ntcp2-transport/066-candidate.md` exists and carries the schema marker
  or `declared-not-executable` status and the typed blocker;
- `plans/closure/ntcp2-transport/066-closure.md` exists and records the typed blocker and
  the close-status;
- `AGENTS.md` records the Plan 066 closure section.

### Phase 5: candidate record (`plans/closure/ntcp2-transport/066-candidate.md`)
...
This document (`plans/closure/ntcp2-transport/066-closure.md`) is the Plan 066 closure
record. The aggregate Milestone 3 closure
(`plans/closure/ntcp2-transport/030-milestone-3-closure.md`) is amended by Plan 066 to
record the Plan 066 close outcome. The Plan 060 closure
(`plans/closure/ntcp2-transport/060-closure.md`) carries a historical pointer only; the
...
Plan 066 candidate record (`plans/closure/ntcp2-transport/066-candidate.md`) is the
...
- `plans/closure/ntcp2-transport/066-candidate.md` — Plan 066 candidate record.
- `plans/closure/ntcp2-transport/066-closure.md` — this closure document.
...
- [x] A new candidate is cut after all implementation work —
      `plans/closure/ntcp2-transport/066-candidate.md` declares the Plan 066 candidate.
