...
1. `plans/closure/ntcp2-transport/091-status.md` must record Plan 091 as partial/incomplete, not closed as a successful corrective pass.
...
5. `plans/closure/ntcp2-transport/087-status.md` must begin with the current Plan 091/092 forward state rather than the superseded Plan 090 zero-address history.
6. Historical Plan 087 and Plan 090 attempts may remain only under clearly labeled historical sections.
7. `plans/closure/ntcp2-transport/088-status.md` must state:
...
Write the ownership decision into `plans/closure/ntcp2-transport/092-status.md` before changing protocol behavior.
...
1. write `plans/closure/ntcp2-transport/092-status.md` with:
...
6. Rewrite `plans/closure/ntcp2-transport/087-status.md` to one authoritative closure section with:

   ```text
   status = passed
   ```

7. Rewrite `plans/closure/ntcp2-transport/088-status.md` so it states:
...
- [ ] `plans/closure/ntcp2-transport/092-status.md` records `status = passed` and the exact ownership/correction.
- [ ] `plans/closure/ntcp2-transport/088-status.md` records Plan 088 as `next_executable` without claiming a reverse result.
