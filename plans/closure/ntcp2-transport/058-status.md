...
| `plans/closure/ntcp2-transport/056-closure.md` | Linked the corrected closure record to the two-lane contract. |
| `plans/closure/ntcp2-transport/056-candidate.md` | Linked the retired candidate record to the two-lane contract. |
| `plans/closure/ntcp2-transport/058-plan056-record-and-candidate-integrity-closure-pass.md` | The plan-of-record carries the formal two-lane contract. |
| `plans/closure/ntcp2-transport/060-fresh-candidate-and-two-run-milestone3-certificate-closure-pass.md` | Added the explicit Lane A / Lane B section and the lane lock requirement. |
...
| `plans/closure/ntcp2-transport/030-milestone-3-closure.md` | Replaced the paragraph that referenced Plan 057 with the explicit Plan 058/059/060 split. |
| `plans/closure/ntcp2-transport/059-reference-side-implementation-and-live-qualification-closure-pass.md` | Updated the dependency block to record ADR 0021 rejection. Removed the Java support topology from the scope. Added the typed blocker `blocked_java_support_topology_rejected` as the closure contract when the ADR is rejected. Workstream C documents the ADR gate and stops without implementing the support topology. |
| `plans/closure/ntcp2-transport/060-fresh-candidate-and-two-run-milestone3-certificate-closure-pass.md` | Updated the dependency block to record that Plan 060 must not start under the current four-direction contract. Added the Lane A / Lane B selection contract. |

## Validation commands and results

All validation commands listed in `plans/closure/ntcp2-transport/058-plan056-record-and-candidate-integrity-closure-pass.md` were executed locally and passed.
...
- [x] `plans/closure/ntcp2-transport/056-candidate.md` is marked retired and names one historical authoritative full SHA.
...
- [x] `plans/closure/ntcp2-transport/056-closure.md` accurately describes local diagnostic artifacts as locally generated and untracked, with the bounded local-diagnostic receipt carrying `artifact_storage: local-untracked`.
- [x] The closure no longer implies a mixed-router handshake was executed by the synthetic driver.
- [x] `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md` is marked superseded before execution.
...
- [x] `plans/closure/ntcp2-transport/058-status.md` records exact commands/results and remaining work.
...
- Cross-host portability of the Plan 046 rootless sealed-namespace
  lane remains deferred to `plans/implementation/ntcp2-transport/047-cross-host-rootless-lane-expansion.md`.
