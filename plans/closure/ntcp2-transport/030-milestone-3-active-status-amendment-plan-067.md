...
- Applies when active status or execution authority in `plans/closure/ntcp2-transport/030-milestone-3-closure.md`, Plan 066 documents, README, AGENTS, architecture documentation, or support documentation conflicts with Plan 067.
...
plans/closure/ntcp2-transport/066-closure.md
