...
- **Plan 062 supersession:** Plan 060 is no longer active execution
  authority. Plan 062 (`plans/implementation/ntcp2-transport/062-ntcp2-evidence-contract-and-architecture-correction.md`)
  ...
  record is preserved verbatim at `plans/closure/ntcp2-transport/060-candidate.md` for
...
```text
plans/closure/ntcp2-transport/060-candidate.md
```
...
Create `plans/closure/ntcp2-transport/060-closure.md` with:
...
- `plans/closure/ntcp2-transport/056-closure.md` with a historical pointer only;
- `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md` with supersession pointer;
...
- [ ] `plans/closure/ntcp2-transport/030-milestone-3-closure.md` is updated accurately.
...
- `plans/closure/ntcp2-transport/060-candidate.md` or equivalent immutable candidate receipt;
...
- reviewer record;
- validation receipt;
- `plans/closure/ntcp2-transport/060-closure.md`;
