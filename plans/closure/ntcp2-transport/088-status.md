...
`plans/implementation/ntcp2-transport/094-plan093-completion-and-plan087-to-plan088-handoff.md`.
...
(`plans/implementation/ntcp2-transport/072-079-gate-amendment-plan-088.md`) records the change.
The static boundary checker
(`scripts/check-ntcp2-interoperability.sh`) rejects any future
`plans/closure/ntcp2-transport/088-status.md` that re-introduces the legacy
...
- `scripts/check-ntcp2-interoperability.sh` — extended to enforce
  ...
  `plans/closure/ntcp2-transport/088-status.md` decision token plus the
...
lane is deferred to `plans/implementation/ntcp2-transport/047-cross-host-rootless-lane-expansion.md`.
...
(`plans/implementation/ntcp2-transport/072-079-gate-amendment-plan-088.md`).
...
`plans/closure/ntcp2-transport/088-status.md` decision token, the prohibition of the
