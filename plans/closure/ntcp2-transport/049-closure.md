...
`plans/implementation/ntcp2-transport/049-multipass-lifecycle-ownership-corrective-pass.md`. It does not
...
The exact local commands and results are maintained in `plans/closure/ntcp2-transport/049-status.md`.
