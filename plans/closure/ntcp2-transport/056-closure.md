...
- `plans/closure/ntcp2-transport/056-candidate.md` — the frozen candidate SHA
...
record (`plans/closure/ntcp2-transport/030-milestone-3-closure.md`) is updated as part of
Plan 058 to reflect the Plan 056 candidate retirement and the
Plan 057 supersession. The Plan 056 candidate document
(`plans/closure/ntcp2-transport/056-candidate.md`) is marked retired; the historical
...
`plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md` to own
