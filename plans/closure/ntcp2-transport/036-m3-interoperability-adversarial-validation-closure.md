...
- `plans/closure/ntcp2-transport/031-closure.md` exists.
- `plans/closure/ntcp2-transport/032-closure.md` validates crypto/transcript vectors.
- `plans/closure/ntcp2-transport/033-closure.md` validates initiator/responder handshakes.
- `plans/closure/ntcp2-transport/034-closure.md` validates data-phase frames and blocks.
- `plans/closure/ntcp2-transport/035-closure.md` validates supervised TCP/link management and private-testnet harnesses.
...
Also create `plans/closure/ntcp2-transport/036-closure.md` for this plan-specific execution record.
...
- `plans/closure/ntcp2-transport/036-closure.md` and `plans/closure/ntcp2-transport/030-milestone-3-closure.md` exist with exact evidence;
