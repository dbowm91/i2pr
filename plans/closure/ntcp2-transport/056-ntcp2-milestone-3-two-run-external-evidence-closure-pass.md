...
Create `plans/closure/ntcp2-transport/056-candidate.md` containing:
...
Create `plans/closure/ntcp2-transport/056-closure.md` containing:
...
Once `plans/closure/ntcp2-transport/056-candidate.md` names the commit, do not edit source during an authoritative run. A smaller model must not “quick fix” a script in the guest and continue.
...
20. `plans/closure/ntcp2-transport/056-closure.md` accurately records the bounded scope and limitations.
