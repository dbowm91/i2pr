...
- `plans/closure/ntcp2-transport/030-milestone-3-closure.md` only after all gates pass.
...
```text
plans/closure/ntcp2-transport/037-closure.md
```
...
- `plans/closure/ntcp2-transport/037-closure.md` exists;
- `plans/closure/ntcp2-transport/030-milestone-3-closure.md` is updated from blocked to complete only if every Milestone 3 criterion is met.
