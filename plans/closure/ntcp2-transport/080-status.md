...
`plans/implementation/ntcp2-transport/078-first-real-i2pd-two-way-execution-and-bounded-correction.md`
status line: `blocked-protocol-defect (2026-08-01: i2pr-side pre-protocol
RouterInfo failure; see plans/closure/ntcp2-transport/080-status.md and
target/interop/evidence/multipass/plan080-20260801034138-c8bec3f5/directions/i2pr-to-i2pd-ipv4.json)`.

`plans/closure/ntcp2-transport/078-status.md` adds a `## Blocked-protocol-defect` section
...
status line: `planned (blocked by Plan 078 closed-as-blocked-protocol-defect; see plans/closure/ntcp2-transport/080-status.md)`.
...
`plans/closure/ntcp2-transport/077-status.md` adds a `## Lane D qualification` section
