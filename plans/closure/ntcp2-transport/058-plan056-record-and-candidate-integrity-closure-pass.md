...
- Starting repository state at authoring: current `main` contains the Plan 053-056 implementation surface, `plans/closure/ntcp2-transport/056-candidate.md`, `plans/closure/ntcp2-transport/056-closure.md`, and `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md`.
...
- `plans/closure/ntcp2-transport/056-candidate.md` declares `fbf2cdb9ec12d35c7b7422c412e09d6db2d2d0cf`;
- its validation narrative also refers to `2457b74`;
- `plans/closure/ntcp2-transport/056-closure.md` later describes `1eb6cd640ce3c3e5141b62910fcae8d42f72c54a` as the source commit;
...
- `plans/closure/ntcp2-transport/056-candidate.md`
- `plans/closure/ntcp2-transport/056-closure.md`
- `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md`
- `plans/closure/ntcp2-transport/030-milestone-3-closure.md`
...
- a `plans/closure/ntcp2-transport/058-status.md` closure record
...
Create a checklist in `plans/closure/ntcp2-transport/058-status.md` listing each affected file and the correction made. Do not rely on one global replacement: each occurrence must be reviewed semantically.
...
Update `plans/closure/ntcp2-transport/056-candidate.md`:
...
Update `plans/closure/ntcp2-transport/056-closure.md` so it states precisely:
...
Update the top of `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md`:
...
- [ ] `plans/closure/ntcp2-transport/056-candidate.md` is marked retired and names one historical authoritative full SHA.
- [ ] The retired candidate is explicitly forbidden for future external execution.
- [ ] `plans/closure/ntcp2-transport/056-closure.md` accurately describes local diagnostic artifacts as locally generated and untracked, unless tracked artifacts actually exist.
- [ ] The closure no longer implies a mixed-router handshake was executed by the synthetic driver.
- [ ] `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md` is marked superseded before execution.
...
- [ ] `plans/closure/ntcp2-transport/058-status.md` records exact commands/results and remaining work.
...
- corrected `plans/closure/ntcp2-transport/056-candidate.md`;
- corrected `plans/closure/ntcp2-transport/056-closure.md`;
- superseded `plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md`;
...
- `plans/closure/ntcp2-transport/058-status.md`;
