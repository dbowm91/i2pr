...
- `plans/closure/ntcp2-transport/030-milestone-3-closure.md` — added the Plan 074 active
  correction banner.
- `plans/closure/ntcp2-transport/069-status.md` — added the Plan 074 supersession note
