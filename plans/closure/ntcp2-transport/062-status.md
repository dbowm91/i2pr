...
The Plan 060 candidate (`plans/closure/ntcp2-transport/060-candidate.md`) is now
...
- [x] `plans/closure/ntcp2-transport/062-status.md` records exact commits and makes no
      external pass claim.
