...
`plans/implementation/ntcp2-transport/046-rootless-sealed-namespace-evidence-lane.md` and
...
The reproducers are versioned in `plans/closure/ntcp2-transport/046-closure.md` and depended on
...
- **Cross-host recovery.** Open `plans/implementation/ntcp2-transport/047-cross-host-rootless-lane-expansion.md`.
