...
closure_record_commit = <the commit that lands plans/closure/ntcp2-transport/060-candidate.md
                          and plans/closure/ntcp2-transport/060-closure.md>
```
...
trail. The closure record is `plans/closure/ntcp2-transport/060-closure.md`. NTCP2 remains
