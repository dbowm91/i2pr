...
> now `plans/closure/ntcp2-transport/045-ntcp2-mixed-router-proof-closure-corrective-pass.md`;
...
the retained sanitized records directly against `plans/implementation/workspace-foundation/000-mvp-roadmap.md`
