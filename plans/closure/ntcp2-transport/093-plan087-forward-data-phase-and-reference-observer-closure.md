...
plans/closure/ntcp2-transport/091-status.md
plans/closure/ntcp2-transport/092-status.md
README.md
AGENTS.md
...
6. Rewrite `plans/closure/ntcp2-transport/087-status.md` to:
...
7. Rewrite `plans/closure/ntcp2-transport/088-status.md` to:
