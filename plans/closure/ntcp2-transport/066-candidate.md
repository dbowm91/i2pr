...
commit and is recorded separately in `plans/closure/ntcp2-transport/066-closure.md`. No
...
closure_record_commit = <the commit that lands plans/closure/ntcp2-transport/066-candidate.md
                          and plans/closure/ntcp2-transport/066-closure.md>
```
...
an audit trail. The closure record is `plans/closure/ntcp2-transport/066-closure.md`. NTCP2
