...
Plan 062 (`plans/implementation/ntcp2-transport/062-ntcp2-evidence-contract-and-architecture-correction.md`)
supersedes the Plan 060 execution authority. The Plan 060 candidate
is retired (`plans/closure/ntcp2-transport/060-candidate.md`) and may not be re-pinned or
...
(`plans/closure/ntcp2-transport/060-candidate.md`). The Plan 060 plan-of-record explicitly
...
| Prerequisite | Status |
| --- | --- |
| Plan 056 candidate retired | Yes (`plans/closure/ntcp2-transport/056-candidate.md` declares `retired; never used for an authoritative external run`) |
| Plan 057 superseded | Yes (`plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md` declares `superseded before execution by Plans 058, 059, and 060`) |
...
| Plan 059 typed blocker marker | Yes (`blocked_java_support_topology_rejected` recorded in `plans/closure/ntcp2-transport/059-status.md`, the Java qualification receipt, and `plan059.plan059_typed_blocker`) |
...
- `plans/closure/ntcp2-transport/060-candidate.md` exists and carries the schema marker or
  `declared-not-executable` status and the typed blocker;
- `plans/closure/ntcp2-transport/060-closure.md` exists and records the typed blocker and
  the close-status;
- `AGENTS.md` records the Plan 060 closure section.

### Phase 5: candidate record (`plans/closure/ntcp2-transport/060-candidate.md`)
...
This document (`plans/closure/ntcp2-transport/060-closure.md`) is the Plan 060 closure
record. The aggregate Milestone 3 closure
(`plans/closure/ntcp2-transport/030-milestone-3-closure.md`) is amended by Plan 060 to
record the Plan 060 close outcome. The Plan 056 closure
(`plans/closure/ntcp2-transport/056-closure.md`) carries a historical pointer only; the
Plan 057 plan (`plans/implementation/ntcp2-transport/057-cross-host-milestone-3-external-evidence-run.md`)
...
Plan 060 candidate record (`plans/closure/ntcp2-transport/060-candidate.md`) is the
...
- `plans/closure/ntcp2-transport/060-candidate.md` — Plan 060 candidate record.
- `plans/closure/ntcp2-transport/060-closure.md` — this closure document.
...
- [x] A new candidate is cut after all implementation work —
      `plans/closure/ntcp2-transport/060-candidate.md` declares the Plan 060 candidate.
...
- [x] `plans/closure/ntcp2-transport/030-milestone-3-closure.md` is updated accurately
...
- The Plan 046 rootless sealed-namespace lane becomes runnable on
  ...
  `plans/implementation/ntcp2-transport/047-cross-host-rootless-lane-expansion.md`.
