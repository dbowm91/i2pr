...
- `plans/closure/ntcp2-transport/091-status.md`, `plans/closure/ntcp2-transport/087-status.md`, `plans/closure/ntcp2-transport/088-status.md` —
...
- WP12: the closure reconciliation that rewrites `plans/closure/ntcp2-transport/087-status.md`,
  `plans/closure/ntcp2-transport/088-status.md`, and creates `plans/093-status.md`.
