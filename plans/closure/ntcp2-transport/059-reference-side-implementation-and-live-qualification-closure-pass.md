...
Write `plans/closure/ntcp2-transport/059-status.md` with:
...
External qualification commands and receipts must be recorded in `plans/closure/ntcp2-transport/059-status.md`.
...
- [ ] `plans/closure/ntcp2-transport/059-status.md` records exact implementation commit, qualification environment, artifact digests, controls, and remaining protocol defects.
...
- `plans/closure/ntcp2-transport/059-status.md`.
