...
`plans/implementation/ntcp2-transport/050-multipass-cloud-init-recovery-and-guest-probe-pass.md` is the
...
- Closure: write `plans/closure/ntcp2-transport/050-closure.md` only after WP 7 produces a
