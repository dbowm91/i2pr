...
- Corrective/completion plan:
  [`plans/closure/exploratory-tunnels/115-completion-emissary-native-q0.md`](115-completion-emissary-native-q0.md)
- Predecessor: [`plans/closure/exploratory-tunnels/114-status.md`](114-status.md)
- Immediate successor:
  [`plans/implementation/exploratory-tunnels/116-local-tunnel-data-plane.md`](../../implementation/exploratory-tunnels/116-local-tunnel-data-plane.md)
...
- [`plans/implementation/exploratory-tunnels/116-local-tunnel-data-plane.md`](../../implementation/exploratory-tunnels/116-local-tunnel-data-plane.md)
- [`plans/implementation/exploratory-tunnels/116-handoff.md`](../../implementation/exploratory-tunnels/116-handoff.md)
