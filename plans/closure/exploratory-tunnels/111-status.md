...
- Plan-of-record:
  [`plans/implementation/exploratory-tunnels/111-short-build-final-local-conformance-correction.md`](../../implementation/exploratory-tunnels/111-short-build-final-local-conformance-correction.md)
- Handoff: [`plans/implementation/exploratory-tunnels/111-handoff.md`](../../implementation/exploratory-tunnels/111-handoff.md)
- Predecessors: [`plans/closure/exploratory-tunnels/109-status.md`](109-status.md),
  [`plans/closure/exploratory-tunnels/110-status.md`](110-status.md)
...
[`plans/closure/exploratory-tunnels/112-status.md`](112-status.md); no live interoperability claim is
implied.
...
- `plans/closure/exploratory-tunnels/109-status.md` and `plans/closure/exploratory-tunnels/110-status.md` —
