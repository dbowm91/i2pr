...
- Final closure: [`plans/closure/exploratory-tunnels/111-status.md`](111-status.md)
...
historical implementation record in `plans/closure/exploratory-tunnels/108-status.md` and
