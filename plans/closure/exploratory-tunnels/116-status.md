...
- Original plan: [`116-local-tunnel-data-plane.md`](../../implementation/exploratory-tunnels/116-local-tunnel-data-plane.md)
...
- Handoff: [`116-handoff.md`](../../implementation/exploratory-tunnels/116-handoff.md)
...
T4 plans/closure/exploratory-tunnels/116-status.md and plans/implementation/exploratory-tunnels/116-handoff.md now agree on
