...
- Status: **closed**.
- Date: 2026-08-14.
- Plan-of-record: `plans/implementation/exploratory-tunnels/107-milestone-5-exploratory-tunnel-substrate.md`.
...
| 16 | `plans/implementation/exploratory-tunnels/107-milestone-5-exploratory-tunnel-substrate.md` | plan-of-record |
...
`plans/implementation/exploratory-tunnels/108-live-ecies-x25519-short-tunnel-build-construction.md`.
