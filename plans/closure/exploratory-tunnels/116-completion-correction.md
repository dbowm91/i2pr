...
```rust
#[ignore = "Plan 116 provisional scaffolding: see plans/closure/exploratory-tunnels/116-status.md"]
```
...
Update `plans/closure/exploratory-tunnels/116-status.md` only after implementation validation.
...
If one of the local protocol corrections still fails, do **not** create another broad plan. Record the exact failing criterion/stage in `plans/closure/exploratory-tunnels/116-status.md` and continue correcting Plan 116 until the local data-plane contract is complete.
