...
- Parent plan: [`116-local-tunnel-data-plane.md`](../../implementation/exploratory-tunnels/116-local-tunnel-data-plane.md).
...
- Handoff authority: [`116-handoff.md`](../../implementation/exploratory-tunnels/116-handoff.md).
...
```text
plans/closure/exploratory-tunnels/116-status.md
plans/implementation/exploratory-tunnels/116-handoff.md
...
```text
plans/closure/exploratory-tunnels/116-status.md  -> passed-final-local-closure / Plan117 unblocked
plans/implementation/exploratory-tunnels/116-handoff.md -> final-closure-pending / Plan117 blocked
```
...
25. `plans/closure/exploratory-tunnels/116-status.md` and `plans/implementation/exploratory-tunnels/116-handoff.md` agree on closure state and Plan 117 successor state.
