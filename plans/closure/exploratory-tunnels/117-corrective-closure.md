...
- **Ready for execution**.
- Date: **2026-08-18**.
- Corrective plan for [`117-live-exploratory-netdb-integration.md`](../../implementation/exploratory-tunnels/117-live-exploratory-netdb-integration.md).
...
- Handoff authority after this file lands: [`117-handoff.md`](../../implementation/exploratory-tunnels/117-handoff.md).
...
Record the final SHA-256 in `plans/closure/exploratory-tunnels/117-status.md` **before deleting the temporary checkout**.
