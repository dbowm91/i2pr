...
Update `plans/closure/exploratory-tunnels/116-status.md` only after all closure criteria pass.
...
26. `plans/closure/exploratory-tunnels/116-status.md`, `plans/implementation/exploratory-tunnels/116-handoff.md`, and current support documentation agree that Plan 116 is closed and Plan 117 is next.
