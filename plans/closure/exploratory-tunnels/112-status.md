...
- Plan-of-record:
  [`plans/closure/exploratory-tunnels/112-outbound-short-build-pre-delivery-closure.md`](112-outbound-short-build-pre-delivery-closure.md)
- Parent roadmap:
  [`plans/implementation/exploratory-tunnels/112-113-post-plan111-pre-delivery-corrective-roadmap.md`](../../implementation/exploratory-tunnels/112-113-post-plan111-pre-delivery-corrective-roadmap.md)
- Handoff: [`plans/implementation/exploratory-tunnels/112-handoff.md`](../../implementation/exploratory-tunnels/112-handoff.md)
- Predecessor: [`plans/closure/exploratory-tunnels/111-status.md`](111-status.md)
- Successor: [`plans/closure/exploratory-tunnels/113-status.md`](113-status.md)
...
recorded in `plans/closure/exploratory-tunnels/113-status.md`.
