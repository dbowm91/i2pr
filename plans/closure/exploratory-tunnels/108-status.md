...
- Superseded protocol-conformance authority:
  [`plans/implementation/exploratory-tunnels/108-conformance-amendment.md`](../../implementation/exploratory-tunnels/108-conformance-amendment.md)
- Successor corrective authority:
  [`plans/implementation/exploratory-tunnels/109-110-plan108-short-build-protocol-conformance-corrective-roadmap.md`](../../implementation/exploratory-tunnels/109-110-plan108-short-build-protocol-conformance-corrective-roadmap.md)
- Next executable plan: **Plan 109**
  ([`plans/implementation/exploratory-tunnels/109-short-build-record-and-noise-conformance-correction.md`](../../implementation/exploratory-tunnels/109-short-build-record-and-noise-conformance-correction.md))
- Parent authority: Plan 102 + [`plans/implementation/netdb/102-amendment-exploratory-tunnel-dependency.md`](../../implementation/netdb/102-amendment-exploratory-tunnel-dependency.md)
- Predecessor: Plan 107 ([`plans/closure/exploratory-tunnels/107-status.md`](107-status.md))
...
8. **Corrected Plan 107 wire comments.** `crates/i2pr-daemon/src/netdb_seam.rs`,
   `plans/implementation/exploratory-tunnels/107-milestone-5-exploratory-tunnel-substrate.md`, and the
...
- Plan-of-record: [`plans/implementation/exploratory-tunnels/108-live-ecies-x25519-short-tunnel-build-construction.md`](../../implementation/exploratory-tunnels/108-live-ecies-x25519-short-tunnel-build-construction.md)
- Predecessor: [`plans/implementation/exploratory-tunnels/107-milestone-5-exploratory-tunnel-substrate.md`](../../implementation/exploratory-tunnels/107-milestone-5-exploratory-tunnel-substrate.md)
