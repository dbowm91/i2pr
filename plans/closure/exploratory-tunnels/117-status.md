...
- Original plan: [`117-live-exploratory-netdb-integration.md`](../../implementation/exploratory-tunnels/117-live-exploratory-netdb-integration.md)
...
- Handoff: [`117-handoff.md`](../../implementation/exploratory-tunnels/117-handoff.md)
- Roadmap: [`115-117-external-delivery-to-live-netdb-roadmap.md`](../../implementation/exploratory-tunnels/115-117-external-delivery-to-live-netdb-roadmap.md)
...
[`plans/implementation/destination-streaming/118-123-milestone6-router-construction-roadmap.md`](../../implementation/destination-streaming/118-123-milestone6-router-construction-roadmap.md).
