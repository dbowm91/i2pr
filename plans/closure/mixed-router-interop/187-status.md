...
isolates and corrects (see [`plans/closure/mixed-router-interop/190-status.md`](190-status.md);
Plan 190 is now passed locally with the corrected reply path).

Plan of record:
[`plans/implementation/mixed-router-interop/187-m6-remote-leaseset2-and-destination-garlic-routing.md`](../../implementation/mixed-router-interop/187-m6-remote-leaseset2-and-destination-garlic-routing.md).
