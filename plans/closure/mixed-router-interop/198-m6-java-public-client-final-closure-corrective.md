...
```text
plans/closure/mixed-router-interop/194-status.md
...
27. exact head + both reference pins + workflow run IDs are recorded in `plans/closure/mixed-router-interop/198-status.md`;
