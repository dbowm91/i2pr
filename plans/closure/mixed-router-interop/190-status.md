...
Plan of record:
[`plans/implementation/mixed-router-interop/190-m6-inbound-netdb-reply-path-tunnel-id-corrective.md`](../../implementation/mixed-router-interop/190-m6-inbound-netdb-reply-path-tunnel-id-corrective.md).
...
1. `plans/implementation/mixed-router-interop/190-m6-inbound-netdb-reply-path-tunnel-id-corrective.md`
2. `plans/closure/mixed-router-interop/190-status.md` (this file; newest authority)
3. `plans/closure/mixed-router-interop/191-status.md` (Plan 191 stopped at boundary E; documented defect)
4. `plans/implementation/mixed-router-interop/191-m6-inbound-destination-delivery-boundary.md` (boundary-E plan)
5. `plans/closure/mixed-router-interop/192-status.md` (registered follow-up; next executable)
6. `plans/implementation/mixed-router-interop/192-m6-i2cp-wire-format-corrective.md` (the I2CP-style Data body wire-format corrective)
7. `plans/closure/mixed-router-interop/188-status.md` for retained authenticated build/install evidence and the destination rows now blocked on Plan 192
...
11. `plans/closure/mixed-router-interop/189-status.md` only after Plan 188 first-family destination + Streaming work genuinely closes
