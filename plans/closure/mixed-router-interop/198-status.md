...
Plan of record:
[`plans/closure/mixed-router-interop/198-m6-java-public-client-final-closure-corrective.md`](198-m6-java-public-client-final-closure-corrective.md).
...
`plans/closure/service-tunnels/199-status.md`. The original `blocked-public-client-
...
`plans/closure/service-tunnels/195-status.md` is reactivated from
...
That transition is recorded in `plans/closure/mixed-router-interop/201-status.md` §"On Plan
