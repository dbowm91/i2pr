...
next = plans/closure/destination-streaming/130-m6-final-wire-runtime-corrective-closure.md (closed)
```
...
See [`plans/closure/destination-streaming/130-status.md`](130-status.md) and the Plan 130 addendum in
...
[`plans/closure/destination-streaming/129-status.md`](129-status.md).
