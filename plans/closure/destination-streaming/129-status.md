...
defect. See [`plans/closure/destination-streaming/130-status.md`](130-status.md) for the current
...
Plan of record:
[`plans/implementation/destination-streaming/129-m6-integrated-destination-streaming-final-gate.md`](../../implementation/destination-streaming/129-m6-integrated-destination-streaming-final-gate.md).
...
[`plans/implementation/destination-streaming/126-129-milestone6-final-corrective-roadmap.md`](../../implementation/destination-streaming/126-129-milestone6-final-corrective-roadmap.md).
