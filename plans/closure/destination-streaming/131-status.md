...
- Plan of record:
  [`plans/closure/destination-streaming/131-m6-final-local-correctness-closure.md`](131-m6-final-local-correctness-closure.md).
- Plan 131's substantive implementation is retained unchanged. This
  ...
  local closure authority**. See `plans/closure/destination-streaming/133-status.md`.
...
`plans/closure/destination-streaming/133-status.md`. Plans 131 and 132 are historical
