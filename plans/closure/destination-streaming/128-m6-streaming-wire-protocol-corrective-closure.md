...
- Successor: `plans/implementation/destination-streaming/129-m6-integrated-destination-streaming-final-gate.md`.
...
Write `plans/closure/destination-streaming/128-status.md` with:
...
next = plans/implementation/destination-streaming/129-m6-integrated-destination-streaming-final-gate.md
```
