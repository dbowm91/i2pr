...
- `plans/implementation/workspace-foundation/000-mvp-roadmap.md` clarification that the currently blocked independent-router/mixed-router interoperability criteria remain external acceptance debt and are not a prerequisite for beginning Milestone 7 in the constrained development environment.
...
Update `plans/closure/destination-streaming/133-status.md` only enough to record that a later concrete receive-window defect was discovered and closed by Plan 134, making Plan 134 the final local Milestone 6 authority.
...
After green acceptance, `plans/closure/destination-streaming/134-status.md` must become:
...
### F3. Clarify `plans/implementation/workspace-foundation/000-mvp-roadmap.md`
...
- [ ] `plans/implementation/workspace-foundation/000-mvp-roadmap.md` clearly distinguishes local progression from outstanding external interoperability acceptance.
