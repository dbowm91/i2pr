...
- Date: 2026-08-19.
- Plan of record: [`plans/implementation/destination-streaming/120-m6-destination-lifecycle-and-tunnel-pools.md`](../../implementation/destination-streaming/120-m6-destination-lifecycle-and-tunnel-pools.md).
- Parent roadmap: [`plans/implementation/destination-streaming/118-123-milestone6-router-construction-roadmap.md`](../../implementation/destination-streaming/118-123-milestone6-router-construction-roadmap.md).
...
next                                     = plans/implementation/destination-streaming/121-m6-ecies-garlic-session-layer.md
```
