...
- Status: **closed**
- Date: 2026-08-19
- Plan-of-record: [`118-planning-authority-cleanup-and-plan117-disposition.md`](../../implementation/destination-streaming/118-planning-authority-cleanup-and-plan117-disposition.md)
...
- separation of external acceptance debt from the product roadmap
  under section 8 of
  [`118-123-milestone6-router-construction-roadmap.md`](../../implementation/destination-streaming/118-123-milestone6-router-construction-roadmap.md);
- synchronized authority across `plans/implementation/workspace-foundation/000-mvp-roadmap.md`,
  `plans/implementation/exploratory-tunnels/115-117-external-delivery-to-live-netdb-roadmap.md`,
  `plans/closure/exploratory-tunnels/117-status.md`, `plans/implementation/exploratory-tunnels/117-handoff.md`,
  `plans/implementation/destination-streaming/118-123-milestone6-router-construction-roadmap.md`,
  `README.md`, `AGENTS.md`,
...
See [`119-m6-leaseset2-protocol-foundation.md`](../../implementation/destination-streaming/119-m6-leaseset2-protocol-foundation.md)
