...
- Authority: `plans/implementation/destination-streaming/126-130-milestone6-final-corrective-roadmap.md`.
...
Do not mark Milestone 6 closed merely because `plans/closure/destination-streaming/129-status.md` historically says `passed-milestone6-integrated-local-product-gate`. Plan 130 supersedes that closure decision until this plan's acceptance criteria are satisfied.
...
- `plans/closure/destination-streaming/126-status.md` — note that Plan 130 corrected the production Elligator representation while retaining Plan 126 cryptographic foundation;
- `plans/closure/destination-streaming/128-status.md` — note that Plan 130 corrected sequence/ACK semantics while retaining Plan 128 packet codec;
- `plans/closure/destination-streaming/129-status.md` — classify the historical gate as superseded by Plan 130 final closure;
- create/finalize `plans/closure/destination-streaming/130-status.md`;
- `plans/implementation/destination-streaming/126-130-milestone6-final-corrective-roadmap.md`;
- README;
- AGENTS.md;
