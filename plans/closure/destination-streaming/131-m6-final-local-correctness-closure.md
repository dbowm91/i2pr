...
- This plan is the **current Milestone 6 closure authority** and supersedes the closure decision recorded by `plans/closure/destination-streaming/130-status.md` until the acceptance criteria below pass.
...
The landed Plan 130 integrated trajectory proves (1) and (3), but does not exercise (2) as a distinct full-stack case. `plans/closure/destination-streaming/130-status.md` nevertheless says all three were proven.
...
- [ ] `plans/closure/destination-streaming/130-status.md` is retained as historical Plan 130 evidence but marked superseded/reopened by Plan 131.
