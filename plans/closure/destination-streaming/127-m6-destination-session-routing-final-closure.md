...
- Predecessor: `plans/implementation/destination-streaming/126-m6-ecies-destination-ratchet-corrective-foundation.md`.
- Successor: `plans/closure/destination-streaming/128-m6-streaming-wire-protocol-corrective-closure.md`.
...
next = plans/closure/destination-streaming/128-m6-streaming-wire-protocol-corrective-closure.md
```
