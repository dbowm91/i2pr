...
- Date: 2026-08-19
- Plan-of-record: [`119-m6-leaseset2-protocol-foundation.md`](../../implementation/destination-streaming/119-m6-leaseset2-protocol-foundation.md)
...
See
[`plans/implementation/destination-streaming/120-m6-destination-lifecycle-and-tunnel-pools.md`](plans/implementation/destination-streaming/120-m6-destination-lifecycle-and-tunnel-pools.md)
