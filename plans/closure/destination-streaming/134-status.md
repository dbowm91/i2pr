...
- Plan of record:
  [`plans/closure/destination-streaming/134-m6-recv-window-ack-ceiling-closure.md`](134-m6-recv-window-ack-ceiling-closure.md).
...
At closure, `plans/implementation/workspace-foundation/000-mvp-roadmap.md` must also be clarified so its historical independent-router/mixed-router Milestone 6 criteria remain explicit eventual MVP acceptance debt rather than being misread as a prerequisite for beginning Milestone 7 in the constrained development environment.
