...
- Plan of record: [`plans/implementation/netdb/102-amendment-exploratory-tunnel-dependency.md`](../../implementation/netdb/102-amendment-exploratory-tunnel-dependency.md)
- Parent authority: [`plans/implementation/netdb/102-milestone-4-routerinfo-netdb-authority-and-roadmap.md`](../../implementation/netdb/102-milestone-4-routerinfo-netdb-authority-and-roadmap.md)
- Short-build closure authority: [`plans/closure/exploratory-tunnels/114-status.md`](../exploratory-tunnels/114-status.md)
- Active successor: [`plans/implementation/exploratory-tunnels/115-qualified-independent-short-build-consumption-and-external-delivery.md`](../../implementation/exploratory-tunnels/115-qualified-independent-short-build-consumption-and-external-delivery.md)
- Handoff: [`plans/implementation/exploratory-tunnels/115-handoff.md`](../../implementation/exploratory-tunnels/115-handoff.md)
...
The detailed gate definitions are in [`plans/implementation/exploratory-tunnels/115-117-external-delivery-to-live-netdb-roadmap.md`](../../implementation/exploratory-tunnels/115-117-external-delivery-to-live-netdb-roadmap.md).
...
- [`plans/closure/exploratory-tunnels/107-status.md`](../exploratory-tunnels/107-status.md)
- [`plans/closure/exploratory-tunnels/111-status.md`](../exploratory-tunnels/111-status.md)
- [`plans/closure/exploratory-tunnels/112-status.md`](../exploratory-tunnels/112-status.md)
- [`plans/closure/exploratory-tunnels/113-status.md`](../exploratory-tunnels/113-status.md)
- [`plans/closure/exploratory-tunnels/114-status.md`](../exploratory-tunnels/114-status.md)
- [`specs/references/short-build-inbound-creator-key.md`](../specs/references/short-build-inbound-creator-key.md)

Active execution:

- [`plans/implementation/exploratory-tunnels/115-qualified-independent-short-build-consumption-and-external-delivery.md`](../../implementation/exploratory-tunnels/115-qualified-independent-short-build-consumption-and-external-delivery.md)
- [`plans/implementation/exploratory-tunnels/115-handoff.md`](../../implementation/exploratory-tunnels/115-handoff.md)
