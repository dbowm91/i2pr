...
Plan of record: [`209-m10-product-only-remote-http-and-irc-application-acceptance-corrective.md`](../../implementation/service-tunnels/209-m10-product-only-remote-http-and-irc-application-acceptance-corrective.md).
