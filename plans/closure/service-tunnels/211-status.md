...
Plan of record: [`211-m10-product-only-remote-http-irc-final-acceptance-corrective.md`](../../implementation/service-tunnels/211-m10-product-only-remote-http-irc-final-acceptance-corrective.md).
