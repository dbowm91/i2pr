...
Plan of record:
[`plans/implementation/service-tunnels/180-m10-service-tunnel-composition-reconcile-and-hardening.md`](../../implementation/service-tunnels/180-m10-service-tunnel-composition-reconcile-and-hardening.md).

Roadmap authority:
[`plans/implementation/service-tunnels/173-m10-service-tunnels-http-socks5-irc-roadmap.md`](../../implementation/service-tunnels/173-m10-service-tunnels-http-socks5-irc-roadmap.md)
([`plans/closure/service-tunnels/173-status.md`](173-status.md)).

Prior M10 authority:

- Foundation:
  [`plans/implementation/service-tunnels/174-m10-service-tunnel-foundation-and-shared-stream-runtime.md`](../../implementation/service-tunnels/174-m10-service-tunnel-foundation-and-shared-stream-runtime.md)
  ([`plans/closure/service-tunnels/174-status.md`](174-status.md))
- Generic client/server tunnels:
  [`plans/implementation/service-tunnels/175-m10-generic-client-server-service-tunnels.md`](../../implementation/service-tunnels/175-m10-generic-client-server-service-tunnels.md)
  ([`plans/closure/service-tunnels/175-status.md`](175-status.md))
- HTTP `.i2p` proxy + CONNECT:
  [`plans/implementation/service-tunnels/176-m10-http-i2p-proxy-and-connect.md`](../../implementation/service-tunnels/176-m10-http-i2p-proxy-and-connect.md)
  ([`plans/closure/service-tunnels/176-status.md`](176-status.md))
- SOCKS5 `.i2p` CONNECT:
  [`plans/implementation/service-tunnels/177-m10-socks5-i2p-connect-proxy.md`](../../implementation/service-tunnels/177-m10-socks5-i2p-connect-proxy.md)
  ([`plans/closure/service-tunnels/177-status.md`](177-status.md))
- IRC `.i2p` client profile + privacy filter:
  [`plans/implementation/service-tunnels/178-m10-irc-client-profile-and-privacy-filtering.md`](../../implementation/service-tunnels/178-m10-irc-client-profile-and-privacy-filtering.md)
  ([`plans/closure/service-tunnels/178-status.md`](178-status.md))
- IRC `.i2p` server profile + authenticated peer hostname:
  [`plans/implementation/service-tunnels/179-m10-irc-server-profile-and-authenticated-peer-hostname.md`](../../implementation/service-tunnels/179-m10-irc-server-profile-and-authenticated-peer-hostname.md)
  ([`plans/closure/service-tunnels/179-status.md`](179-status.md))
...
14. `plans/closure/service-tunnels/180-status.md` records evidence and advances
