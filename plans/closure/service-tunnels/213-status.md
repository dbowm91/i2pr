...
Plan of record: [`213-m10-router-backed-generic-external-qualification-and-evidence-corrective.md`](../../implementation/service-tunnels/213-m10-router-backed-generic-external-qualification-and-evidence-corrective.md).
...
(see `plans/closure/service-tunnels/212-status.md`); Plan 214 is executable.
