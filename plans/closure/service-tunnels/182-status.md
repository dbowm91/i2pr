...
Plan of record:
[`plans/implementation/service-tunnels/182-m10-local-delivery-corrective.md`](../../implementation/service-tunnels/182-m10-local-delivery-corrective.md).
...
next_executable_plan = 181 (local matrix green; remote rows blocked, see plans/closure/service-tunnels/181-status.md)
```
...
Full workspace floor: see `plans/closure/service-tunnels/181-status.md` (run on the
