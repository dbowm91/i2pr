...
Plan of record: [`210-m10-real-service-destination-tunnel-material-and-inbound-streaming-corrective.md`](../../implementation/service-tunnels/210-m10-real-service-destination-tunnel-material-and-inbound-streaming-corrective.md).
...
See `plans/closure/service-tunnels/212-status.md` for the executable handoff.
