...
24. `plans/closure/service-tunnels/181-status.md` records exact closing SHA, workflow run IDs, external client/router pins/versions, artifact IDs/digests, and final scope classification.
