...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending Plan 244. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 243 closed; Plan 244 ready | Plan 244 correlates retained Plan-237/238/239/240 response observers in one hosted response epoch to locate the first real Java→i2pr Streaming reverse-direction boundary. |
...
|---|---|---|---|---|
| M6 mixed-router interop | 244 reverse-direction continuous response attribution | ready | `plans/implementation/mixed-router-interop/244-m6-java-streaming-reverse-direction-continuous-response-attribution.md` | Reuse Plan-237/238/239/240 observers in one hosted response epoch; no publication or production corrective unless the exact live boundary authorizes it. |

## Blocked work

| Subsystem | Plan | Blocker |
|---|---|---|
| M6 mixed-router interop | 201 | Blocked on M6 Java Streaming reverse direction pending Plan 244 plus publication / final-closure axis |
| Service tunnels | 204 | Cross-milestone convergence waits for M6 Java second-family closure pending Plan 244; closed M10 product authority unchanged |
