...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure after Plan 235's exact response boundary. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plans 234–235 closed at bounded Java response boundaries; no active successor | Plan 232 raw reverse pass is retained. Plan 235 proved Java socket-surface readiness and i2pr outbound admission but no inbound TunnelData; M6 Java remains not-yet-passed. |
...
there is no dependency-ready M6 Java successor. Plans 201 and 204 remain
blocked on unresolved Java-family closure evidence.
...
|---|---|---|
| M6 mixed-router interop | 201 | Blocked after Plan 235 at Java socket-surface-ready/no-i2pr-inbound; Java-family publication and final-closure authority remain unresolved |
| Service tunnels | 204 | Cross-milestone convergence waits for M6 Java second-family closure after Plan 235; closed M10 product authority unchanged |
