...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending Plan 240 lookup-failure attribution. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 239 passed at TARGET-LEASESET-LOOKUP-FAILED; Plan 240 ready | Plan 240 reuses P225/P226 exact target-job tracing in the Streaming epoch to explain why Router B is not queried or where the reply/install path first stops. |
