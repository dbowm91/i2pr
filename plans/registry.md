...
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 230 closed; Plan 231 ready: reverse-delivery tunnel-dispatch attribution | Profile bootstrap + forward delivery are proven. Plan 231 attributes the post-`ACCEPTED` path from Java A outbound gateway through C/target IBGW to exact i2pr TunnelData/recovery/Garlic/Destination delivery |
