...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 convergence waits on independent M6 Java second-family closure. Plan 234 is the active M6-only Streaming/final-closure-authority corrective and does not reopen M10 |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 233 superseded before execution; Plan 234 ready: Streaming SYN-ACK + client-LS2 final-closure authority corrective | Plan 232 raw reverse pass is retained. Plan 234 owns the narrow Streaming attribution plus explicit reconciliation of the still-required Plan-200/201 client-LS2 lifecycle rows before any M6 closure claim. |
...
|---|---|---|
| M6 mixed-router interop | 201 | Blocked pending Plan 234 Streaming SYN-ACK and final-closure authority corrective |
| Service tunnels | 204 | Cross-milestone convergence waits for M6 Java second-family closure, now pending Plan 234; closed M10 product authority unchanged |
