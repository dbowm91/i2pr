...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure after the Plan 236 response-emission observability gap. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 236 closed at Java response-emission observability gap | Plan 232 raw reverse pass and Plan 235 socket-surface boundary remain retained. Java-family closure is still blocked; no Router-A or i2pr-owned conclusion was made. |
...
Plan 236 closed at the exact post-accept response-emission observability gap.
Plans 201 and 204 remain blocked on Java-family closure and a future
response-observability corrective.

| Subsystem | Plan | State | Handoff | Dependencies / handoff note |
|---|---|---|---|---|
| M6 mixed-router interop | 236 Java Streaming response-emission + I2CP send attribution | closed | `plans/closure/mixed-router-interop/236-status.md` | Closed at `P236-C-JAVA-RESPONSE-EMISSION-OBSERVABILITY-GAP`; no response-stage, Router-A, tunnel, or i2pr-owned claim. |

## Blocked work

| Subsystem | Plan | Blocker |
|---|---|---|
| M6 mixed-router interop | 201 | Blocked after Plan 236 Java response-emission observability gap; Java-family publication and final-closure authority remain unresolved |
| Service tunnels | 204 | Cross-milestone convergence waits for M6 Java second-family closure after Plan 236; closed M10 product authority unchanged |
...
- `active_plan = none`; `next_executable_plan = none-registered`; Plans 234–236 are closed bounded diagnostics. Plan 201 remains blocked after the Plan 236 response-observability gap, Plan 204 remains blocked on M6 Java closure, and Plan 205 remains retained/deferred.
