...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending Plan 243 reverse direction + publication closure. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 243 closed | Plan 243 closed the hosted stock-client-build qualification on `f359baba57fc7d952ab7f5a5367d34671c590b18`: Direction A established on 2/3 counted same-SHA executions of the frozen Plan-242 Streaming lane; streaming reverse direction bounded at the retained Plan-236 response-emission gap. Plan 201 remains blocked on the streaming reverse direction + publication / final-closure axis. |
...
Full per-plan history (000–243) lives in the subsystem roadmaps §7 tables.
