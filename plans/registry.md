...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending Plan 236 response-emission/I2CP attribution. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plans 234–235 closed at bounded Java response boundaries; Plan 236 ready | Plan 232 raw reverse pass is retained. Plan 236 owns the exact Java response scheduler → PacketQueue/I2PSession → Router-A client-message → target-IBGW attribution before any production change. |
...
Full per-plan history (000–236) lives in the subsystem roadmaps §7 tables.
