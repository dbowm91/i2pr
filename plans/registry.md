...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | Blocked on independent M6 Java second-family closure; Plan 229 closed at the transit-peer stop, Plan 230 is the active profile-population-path attribution |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 229 closed; Plan 230 ready: profile-population-path attribution | Plan 229 proved roles + A-only small-router profile live but stopped at `P229-C-NOT-EXPLORATORY-ELIGIBLE` (tier population empty). Plan 230 attributes the stock profile-population path |
...
- `active_plan = none`; `next_executable_plan = 230-m6-java-profile-population-path-attribution`; Plan 201 and Plan 204 remain blocked, and Plan 205 remains retained/deferred.
