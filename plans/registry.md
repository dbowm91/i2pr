...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending Plan 243. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 242 closed; Plan 243 ready | Plan 243 owns hosted execution of the frozen Plan-242 Streaming lane: qualify the Java+i2pr host, then run three counted same-SHA attempts and classify the first live boundary. |
...
Current authority: Plan 242 passed the stock one-hop selector semantics corrective at the corrected bootstrap/pair-gate boundary, with routine/focused/full workspace floors green but no live counted external attempts on its closure host. Plan 243 is dependency-ready to qualify a capable Java+i2pr execution host and run the frozen Plan-242 lane three times on one SHA with no tuning. Plans 201 and 204 remain blocked on Java-family closure.

| Subsystem | Plan | State | Handoff | Dependencies / handoff note |
|---|---|---|---|---|
| M6 mixed-router interop | 243 hosted stock-client-build qualification | ready | `plans/implementation/mixed-router-interop/243-m6-java-streaming-hosted-stock-client-build-qualification.md` | Host qualification first, then three counted executions of the frozen Plan-242 Streaming lane; no new protocol corrective until a live terminal justifies one. |

## Blocked work

| Subsystem | Plan | Blocker |
|---|---|---|
| M6 mixed-router interop | 201 | Blocked after Plan 242 corrected-bootstrap/pair-gate; streaming axis pending Plan 243 hosted qualification, publication/final-closure axis unchanged |
| Service tunnels | 204 | Cross-milestone convergence waits for M6 Java second-family closure pending Plan 243; closed M10 product authority unchanged |
