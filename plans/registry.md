...
|---|---|---|---|---|
| M6 mixed-router interop | 235 Streaming post-accept response-boundary corrective | ready | `plans/implementation/mixed-router-interop/235-m6-java-streaming-post-accept-response-boundary-corrective.md` | Continue from Plan 234's exact Java-accepted/no-i2pr-inbound boundary; retain Plan-232 raw pass; no production Rust change without a proven i2pr defect. |
...
- `active_plan = none`; Plan 235 is the next executable plan. Plan 201 remains blocked pending Plan 235, Plan 204 remains blocked on M6 Java closure, and Plan 205 remains retained/deferred.
