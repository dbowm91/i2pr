...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending the §20 stock-client-build successor. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 242 closed; §20 stock-client-build successor open | Plan 242 source-locks the 1-in-4 explicit-peer semantics, replaces the Plan-241 exact-via-C hard gate with a non-zero-hop client-pair gate, and accepts any genuine stock client-tunnel population. §20 successor requires its own plan-of-record. |
...
Full per-plan history (000–242) lives in the subsystem roadmaps §7 tables.
