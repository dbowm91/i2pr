...
| Service tunnels | active | `plans/subsystems/service-tunnels-roadmap.md` | Plan 215 passed; Plan 204 convergence open | M10 product authority is closed; Plan 204 remains blocked on independent M6 Java second-family closure pending the Plan-244 §20 stock-response successor + publication closure. |
| M6 mixed-router interop | active | `plans/subsystems/mixed-router-interop-roadmap.md` | Plan 244 closed | Plan 244 closed the continuous response attribution on `154e92d8436dbad0b020a0b19d848d2d227a22af`: Direction A established on 3/3 counted same-SHA executions with fully bound response epochs, reverse direction bounded repeatably at `P244-B-RESPONSE-PACKET-NOT-CONSTRUCTED`. Plan 201 remains blocked on the narrow stock-response successor + publication / final-closure axis. |
...
Full per-plan history (000–244) lives in the subsystem roadmaps §7 tables.
