...
Development targets a smaller interoperable-router milestone before the complete MVP. The current product milestone is **Milestone 6** (destinations, garlic, LeaseSet2, streaming), sequenced in [`plans/118-123-milestone6-router-construction-roadmap.md`](plans/118-123-milestone6-router-construction-roadmap.md) and its corrective roadmap [`plans/126-129-milestone6-final-corrective-roadmap.md`](plans/126-129-milestone6-final-corrective-roadmap.md). Plan 119 closed as `passed-leaseset2-protocol-foundation`; Plan 120 closed as `passed-destination-lifecycle-and-pools`; Plan 121 closed as `passed-ecies-destination-session-layer` (superseded dialect corrected by Plan 126, final local closure restored by Plan 127); Plan 122 closed as `passed-corrected-local-destination-routing` (Plan 124 corrective closure); Plan 123 closed as `passed-corrected-streaming-wire-local` (restored by Plans 128/129); Plan 124 closed as `passed-corrected-destination-routing-local-closure`; Plan 125 is `superseded-by-final-corrective-closure`; Plan 126 closed as `passed-ecies-destination-ratchet-corrective-foundation`; Plan 127 closed as **`passed-destination-session-routing-final-closure`**; Plan 128 closed as **`passed-streaming-wire-protocol-corrective-closure`** (restoring `plan_123 = passed-corrected-streaming-wire-local`). Plan 129 is **`superseded-by-plan130-final-gate`**; Plan 130 is **`superseded-by-plan131-final-local-correctness-gate`** (historical evidence retained in [`plans/130-status.md`](plans/130-status.md)); Plan 131 closed as **`superseded-by-plan132-and-plan133-final-gates`** ([`plans/131-status.md`](plans/131-status.md)): production Elligator branch randomization and the Plan 131 replay, port-ownership, and transactional-send corrections remain retained evidence. Plan 132 closed as **`implementation-landed-evidence-superseded-by-plan133`** ([`plans/132-status.md`](plans/132-status.md)): strict Elligator2 receive-domain validation, layer-isolated replay trajectories, and transactional send ordering. Plan 133 remains successful historical evidence for its replay, Elligator, and transactional-send corrections, now superseded as authority by Plan 134 ([`plans/133-status.md`](plans/133-status.md)). Plan 134 is the current local Milestone 6 authority and closed as **`passed-milestone6-recv-window-ack-ceiling-closure`** ([`plans/134-status.md`](plans/134-status.md), plan-of-record [`plans/134-m6-recv-window-ack-ceiling-closure.md`](plans/134-m6-recv-window-ack-ceiling-closure.md)): rejected `TooFarAhead` packets are state-inert and cannot contaminate later ACK/NACK or piggyback state, with focused policy and manager regressions plus the full local validation gate. Milestone 6 local product is **passed** (`milestone6_interoperable = not-yet-claimed`; external acceptance debt retained separately). Corrective Milestone 6 planning stops here; the next product layer is **SAM baseline planning (Milestone 7)**.
