...
**Documentation map.** Architecture deep-dives live under
[`docs/architecture/`](docs/architecture/) and are indexed from
[`docs/architecture/overview.md`](docs/architecture/overview.md); the
top-level narrative is [`docs/architecture.md`](docs/architecture.md).
Plan-of-record and closure records live under [`plans/`](plans/).
Loadable OpenCode skill bundles live under
...
**Plan hierarchy (closure records are authoritative; per-plan narratives live under `plans/`):**

| Plan | Status | Closure |
| --- | --- | --- |
| 119 | `passed-leaseset2-protocol-foundation` | [`plans/119-status.md`](plans/119-status.md) |
| 120 | `passed-destination-lifecycle-and-pools` | [`plans/120-status.md`](plans/120-status.md) |
| 121 | superseded-by-126 | [`plans/121-status.md`](plans/121-status.md) |
| 122 | `passed-corrected-local-destination-routing` | [`plans/122-status.md`](plans/122-status.md) |
| 123 | `passed-corrected-streaming-wire-local` (restored by 128) | [`plans/123-status.md`](plans/123-status.md) |
| 124 | `passed-plan122-corrective-closure` | [`plans/124-status.md`](plans/124-status.md) |
| 125 | superseded-by-final-corrective-closure | [`plans/125-status.md`](plans/125-status.md) |
| 126 | `passed-ecies-destination-ratchet-corrective-foundation` | [`plans/126-status.md`](plans/126-status.md) |
| 127 | `passed-destination-session-routing-final-closure` | [`plans/127-status.md`](plans/127-status.md) |
| 128 | `passed-streaming-wire-protocol-corrective-closure` | [`plans/128-status.md`](plans/128-status.md) |
| 129 | superseded-by-130 | [`plans/129-status.md`](plans/129-status.md) |
| 130 | superseded-by-131 | [`plans/130-status.md`](plans/130-status.md) |
| 131 | superseded-by-132-and-133 | [`plans/131-status.md`](plans/131-status.md) |
| 132 | `implementation-landed-evidence-superseded-by-plan133` | [`plans/132-status.md`](plans/132-status.md) |
| 133 | `passed-evidence-authority-superseded-by-plan134` | [`plans/133-status.md`](plans/133-status.md) |
| 134 | `passed-milestone6-recv-window-ack-ceiling-closure` (current authority) | [`plans/134-status.md`](plans/134-status.md) |

The local product path and SAM baseline planning guidance is in
[`.opencode/skills/i2pr-local-dev/`](.opencode/skills/i2pr-local-dev/SKILL.md).
...
**Modular monolith** — one process composed from focused crates. Crate boundaries follow security boundaries and protocol ownership. The full ownership map is in
[`docs/architecture/overview.md`](docs/architecture/overview.md); the
per-crate allowlist is in
[`docs/architecture/dependency-graph.md`](docs/architecture/dependency-graph.md);
the per-crate deep-dives are in
[`docs/architecture/i2pr-*.md`](docs/architecture/).
...
**Skill bundles.** Loadable OpenCode skill bundles cover the
routine development seam
([`i2pr-local-dev`](.opencode/skills/i2pr-local-dev/SKILL.md)),
documentation navigation
([`i2pr-architecture`](.opencode/skills/i2pr-architecture/SKILL.md)),
the historical NTCP2 interop harness
([`i2pr-ntcp2-interop`](.opencode/skills/i2pr-ntcp2-interop/SKILL.md);
active lane is closed),
the Plan 046 rootless sealed-namespace lane
([`i2pr-rootless-sandbox`](.opencode/skills/i2pr-rootless-sandbox/SKILL.md)),
and the Plan 048/049/050/051 Multipass recovery lane
([`i2pr-multipass-recovery`](.opencode/skills/i2pr-multipass-recovery/SKILL.md)).
...
Development targets a smaller interoperable-router milestone before the complete MVP. The current product milestone is **Milestone 6** (destinations, garlic, LeaseSet2, streaming), sequenced in [`plans/118-123-milestone6-router-construction-roadmap.md`](plans/118-123-milestone6-router-construction-roadmap.md) and its corrective roadmap [`plans/126-129-milestone6-final-corrective-roadmap.md`](plans/126-129-milestone6-final-corrective-roadmap.md). The current Milestone 6 local closure authority is **Plan 134** ([`plans/134-status.md`](plans/134-status.md), `passed-milestone6-recv-window-ack-ceiling-closure`). Independent-router interoperability is tracked as external acceptance debt. The next product layer is **SAM baseline planning (Milestone 7)**; see [`.opencode/skills/i2pr-local-dev/`](.opencode/skills/i2pr-local-dev/SKILL.md) for the routine development seam and SAM planning stub.
