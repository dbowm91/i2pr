...
next_executable_plan = 200-external-run (consume P200 classification) or 201-branch-g-finalize or 202 (M10 production remote transport composition, parallel-executable); Plans 201 and 202 are intentionally parallel; Plan 204 is the convergence
