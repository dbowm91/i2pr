...
m10_remote_application_interop = locally-passed-once (Plan 214 P214-N on the Commit E tree; hosted double-pass pending)
next_m10_application_plan = plan214-hosted-double-pass (Plan 213 passed; Plan 214 local pass proven on the Commit E tree; Commit F owns the hosted double-pass with `P214-N-passed` twice on one exact SHA; Plan 204 owns the docs/CI/evidence-authority normalization pass; Plan 201 owns the cross-milestone Java second-family closure)
