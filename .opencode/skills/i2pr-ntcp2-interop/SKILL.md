...
tunnel pools, signed Standard LeaseSet2, lifecycle, bounded local
 ...
 `passed-corrected-streaming-wire-local`. The next executable product
 work is Plan 129 (integrated M6 destination-streaming final gate) per
