...
tunnel pools, signed Standard LeaseSet2, lifecycle, bounded local
 ...
 ES traffic in both directions. The next executable product work is
 Plan 128 (streaming wire protocol corrective closure) per
