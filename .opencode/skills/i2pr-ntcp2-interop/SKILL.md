...
tunnel pools, signed Standard LeaseSet2, lifecycle, bounded local
 ...
 SYN / SYN-response lifecycle. The next executable product work is
 the SAM baseline planning (Milestone 7) under the Milestone 6
