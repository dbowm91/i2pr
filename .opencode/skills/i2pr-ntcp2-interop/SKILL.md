...
next_router_construction_plan        = SAM baseline planning (Milestone 7; Milestone 6 closed by Plan 133)
```
 ...
 **`passed-milestone6-integrated-local-product-gate`**
 ...
 local-product gate (now superseded by Plan 131/132/133 — Plan 133
 is the current Milestone 6 local closure authority as
