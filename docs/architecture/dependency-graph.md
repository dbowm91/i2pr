...
| `i2pr-transport-ssu2` (Plan 155) | `i2pr-proto`, `i2pr-transport` + `thiserror` |
...
- `i2pr-transport-ssu2` may not depend on `i2pr-runtime`,
  ...
  `i2pr-netdb`, `i2pr-tunnel`, or `i2pr-client` (Plan 155;
  runtime-neutral protocol foundation only).
