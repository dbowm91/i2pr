...
## Plan 172 - local zero-hop lifecycle corrective (passed; M9 closed)
...
legacy field it is: `DestinationPublic::from_destination` accepts
both X25519 (32-byte static slot, used for ECIES inbound
