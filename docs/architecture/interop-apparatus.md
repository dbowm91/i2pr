...
production NTCP2 code, the i2pd direct driver, or the Plan 065 strict
launcher scenario contract.

The Plan 046 `apparmor_restrict_on` host remains the Plan 046
negative baseline; the Plan 048/049 Multipass recovery lane is
the canonical external path. Plan 070 will execute the Plan 069
lane and update Milestone 3 status based on the Level 1 outcomes.
