...
| Service | HTTP, SOCKS5, IRC, generic TCP, local service tunnels | Plan 174 foundation landed: runtime-neutral `i2pr-service-tunnels` crate (typed kinds, destination policy, Base32/alias validation, loopback-only shapes, central ceilings), shared daemon Streaming pump reused by SAM, strict disabled-by-default `[service_tunnels]` surface. No product listener yet; Plans 175–181 own generic/HTTP/SOCKS/IRC composition. |
