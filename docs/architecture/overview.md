...
bridge (`ShortBuildI2npBridge` in
          ...
          **`passed-destination-session-routing-final-closure`**
          ...
          Plan 129 then closed the integrated M6 destination+Streaming
          final gate as `passed-milestone6-integrated-local-product-gate`
          ([`plans/129-status.md`](../../plans/129-status.md)):
          `milestone6_local_product = passed`,
          `milestone6_interoperable = not-yet-claimed`; the next
          product layer is SAM baseline planning (Milestone 7) per
