...
bridge (`ShortBuildI2npBridge` in
          ...
          **`passed-destination-session-routing-final-closure`**
          ...
          The next executable plan is **Plan 129**
          (integrated M6 destination-streaming final gate) under
